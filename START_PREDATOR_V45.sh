#!/bin/bash
# ===========================================
# 🦁 PREDATOR V45 - ПОВНИЙ ЗАПУСК СИСТЕМИ
# ===========================================
...
echo "🦁 ============================================"
echo "   Predator v45 | Neural Analytics- Повний Запуск"
echo "============================================"
echo ""
...
echo ""
echo "============================================"
echo "✅ Predator v45 | Neural Analyticsготовий до роботи!"
echo "============================================"
echo ""
...
# Cleanup при виході
trap "echo ''; echo '🛑 Зупинка PREDATOR V45...'; kill $MOCK_API_PID 2>/dev/null || true; exit 0" INT TERM
