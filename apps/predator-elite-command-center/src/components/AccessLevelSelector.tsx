      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full px-4">
        {roles.map((role) => (
          <div
            ...
            className={`bg-neutral-950/80 border ${role.borderClass} ${role.glowClass} p-6 rounded-lg transition-all duration-300 cursor-pointer flex flex-col justify-between h-[450px] group hover:-translate-y-2 hover:bg-neutral-900/60 shadow-[0_0_15px_rgba(0,0,0,0.5)] backdrop-blur-md`}
          >
            <div>
