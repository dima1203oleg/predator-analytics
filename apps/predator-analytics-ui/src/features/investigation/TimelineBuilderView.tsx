...
const CATEGORY_CONFIG: Record<EventCategory, { label: string; color: string; bg: string; icon: any }> = {
    ...
    risk:          { label: '� ИЗИК', color: '#f43f5e', bg: 'bg-rose-500/10', icon: AlertTriangle },
...
const MOCK_EVENTS: TimelineEvent[] = [
    ...
    },
    {
        ...
        source: 'АНАЛІТИЧНИЙ_ЯД� О_PREDATOR',
        confidence: 92,
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div className="space-y-4">
                                        <p className="text-[10px] font-black text-slate-700 uppercase tracking-widest italic leading-none">ДЖЕ� ЕЛО_А� ТЕФАКТУ</p>
                            ...
                            <div className="flex items-center gap-10">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[11px] text-slate-500 font-black uppercase tracking-[0.5em] italic mt-2 opacity-80 leading-none">
                                        ГЛИБИННИЙ АНАЛІЗ ЧАСОВИХ ВЕКТО� ІВ ТА П� ИХОВАНИХ ЗВ'ЯЗКІВ
                                    </p>
                                </div>
                            </div>
                        }
