          ...
          <section className={cn(cardGlass, "p-6 sm:p-8")}>
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-lg font-black text-white uppercase italic tracking-tight">АКТИВНІСТЬ ЗАГРОЗ МЕРЕЖІ</h2>
      ...
      <footer className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <button className={cn(cardGlass, "p-5 flex items-center justify-between group hover:border-indigo-500/30 transition-all")}>
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <div className="text-sm font-black text-white uppercase italic">ВЕРИФІКУВАТИ ДАНІ</div>
        ...
        <button className={cn(cardGlass, "p-5 flex items-center justify-between group hover:border-red-500/30 transition-all")}>
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              ...
              <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">ЕКСПОРТ ПРАВОВОГО ДОСЬЄ</div>
            </div>
          </div>
