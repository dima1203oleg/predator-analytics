          ...
          <section className="page-section section-amber p-10 relative group/emerg shadow-xl mt-10">
            <div className="section-header">
              ...
              <div>
                ...
                <p className="section-subtitle"> ішення останньої інстанції</p>
              </div>
            </div>
            ...
            >
              {emergencyMode ? (
                ...
                <>
                  <Power size={20} className="animate-pulse" />  ОЗІ ВАТИ_ЗВ'ЯЗОК_ЯД А
                </>
              )}
            </button>
          </section>
          ...
          <HoloContainer className="p-10 flex flex-col gap-10 overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="p-6 bg-slate-950/40 border border-white/5 rounded-[32px] panel-3d">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-[9px] font-black text-amber-500 uppercase tracking-widest">ЧИСТОТА_МЕ ЕЖІ</span>
              ...
              <div className="p-6 bg-slate-950/40 border border-white/5 rounded-[32px] panel-3d">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">СИНХ _СУТНОСТЕЙ</span>
            ...
            <div className="p-8 bg-slate-950/60 border border-white/5 rounded-[32px]">
              ...
              <div className="flex items-center gap-2 mb-4">
                {['INGEST_ВХІД', 'ПА СИНГ', 'ВАЛІДАЦІЯ', ' ЕЗОЛВІНГ', 'ЗБЕ ЕЖЕНО'].map((step, i) => (
              ...
              <div className="flex justify-between text-[9px] font-mono text-slate-500 uppercase">
                <span>АКТИВНО: ДВИГУН_ ЕЗОЛВІНГУ_СУТНОСТЕЙ</span>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="p-6 bg-slate-950/60 border border-white/5 rounded-[32px] group/item transition-all hover:border-white/20">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">ЖУ НАЛ_ІСТИНИ (Truth Ledger)</span>
                  </div>
                  <div className="text-3xl font-black text-white font-mono tracking-tighter">42,817</div>
                  <div className="text-[9px] font-black text-emerald-400 uppercase mt-2 font-mono">● СИНХ _0ms</div>
                </div>
                <div className="p-6 bg-slate-950/60 border border-white/5 rounded-[32px] group/item transition-all hover:border-white/20">
                  <div className="flex items-center gap-3 mb-4">
        ...
        <div className="col-span-12 xl:col-span-3 flex flex-col gap-10">
          <section className="page-section section-cyan p-10 flex flex-col h-full shadow-xl">
            <div className="section-header">
              ...
              <div>
                <h2 className="section-title">Активний  ой Агентів</h2>
            ...
            <div className="space-y-6 flex-1 mt-4">
              {[
                ...
                { name: 'Інженер', status: ' ЕФАКТО ИТЬ', color: 'text-emerald-400' },
                { name: 'Аудитор', status: 'ВЕ ИФІКУЄ', color: 'text-purple-400' },
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <button className="px-10 py-5 bg-amber-500 text-white rounded-[24px] text-[10px] font-black uppercase tracking-[0.3em] hover:bg-amber-600 transition-all shadow-xl flex items-center gap-3">
            {" ОЗШИ ИТИ_ГО ИЗОНТ_НАГЛЯДУ"} <ArrowUpRight size={18} />
          </button>
        </div>
      </motion.div>
    </div>
