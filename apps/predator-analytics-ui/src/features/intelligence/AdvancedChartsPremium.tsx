          ...
          <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-8 z-20">
             <div className="flex gap-4 p-3 bg-black border-2 border-white/5 rounded-[3rem] shadow-4xl backdrop-blur-3xl">
                {(['week', 'month', 'quarter', 'year'] as const).map((r) => (
                  ...
                  >
                    {r === 'week' ? '7 ДНІВ' : r === 'month' ? '30 ДНІВ' : r === 'quarter' ? 'КВАРТАЛ' : 'РІК_2026'}
                  </button>
                ))}
             </div>
                ...
                <TacticalCard variant="holographic" className="md:col-span-2 p-12 rounded-[4rem] space-y-10 group/card">
                   <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-5">
                         ...
                         <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-none">ДИНАМІКА РИНКОВИХ ТРЕНДІВ</h3>
                      </div>
                ...
                <TacticalCard variant="holographic" className="p-12 rounded-[4rem] space-y-10 group/card">
                   <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-5">
                         ...
                         <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-none">ВЕКТОР ЗРОСТАННЯ</h3>
                      </div>
          ...
          >
            ...
            <div className="flex flex-col xl:flex-row items-center justify-between gap-12 relative z-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  {[
                    { icon: TrendingUp, title: 'ВЕКТОР_ЗРОСТАННЯ', desc: 'Прогнозується ріст на 15% у наступному Q.', color: 'emerald' },
                    { icon: Target, title: 'PATTERN_DETECTION', desc: 'Виявлено аномальну активність у сегменті ЕНЕРГО.', color: 'warning' },
