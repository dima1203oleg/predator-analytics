                ...
                <TacticalCard variant="holographic" className="p-12 rounded-[4rem] space-y-10 group/card">
                   <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-5">
                         ...
                         <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-none">� ОЗПОДІЛ КАТЕГО� ІЙ</h3>
                      </div>
                   </div>
            ...
            <div className="flex flex-col xl:flex-row items-center justify-between gap-12 relative z-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  {[
                    ...
                    { icon: Shield, title: 'RISK_MITIGATION', desc: '� екомендовано диверсифікацію ланцюгів.', color: 'primary' },
                  ].map((insight, i) => (
