        ...
        <div className="flex items-center gap-6 pl-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-6 mt-2">
              ...
              <span className="text-[10px] font-black text-slate-500 font-mono tracking-widest uppercase">
                ПОКАЗНИК_� ИЗИКУ: <span style={{ color: node.risk > 80 ? '#D97706' : node.risk > 60 ? '#f59e0b' : '#10b981' }} className="italic font-black">
                  {node.risk}%
                </span>
              </span>
              {node.nationality && (
...
const UBOMapView: React.FC = () => {
  ...
  const views: Array<{ id: ActiveView; label: string; icon: React.ElementType; badge?: string }> = [
    { id: 'ubo-tree',       label: 'СТ� УКТУ� А_ВЛАСНОСТІ',       icon: Network,      badge: 'ПОК� АЩЕНО' },
    { id: 'pep-tracker',    label: 'PEP_� ОЗВІДКА',           icon: Fingerprint,  badge: 'LIVE' },
    { id: 'shadow-director', label: 'ТІНЬОВИЙ_ДИ� ЕКТО� ',     icon: Eye,          badge: 'AI_ЯД� О' },
  ];
      ...
      <div className="relative z-10 max-w-[1800px] mx-auto p-12 space-y-12">
        ...
        <ViewHeader
          ...
          stats={[
            ...
            { 
              label: isOffline ? 'АВА� ІЙНА_СИНХ� ОНІЗАЦІЯ' : 'ПОКАЗНИК_� ИЗИКУ', 
                  ...
                  <div className="relative group overflow-hidden rounded-[3.5rem] border-2 border-yellow-500/30 bg-gradient-to-br from-yellow-500/10 via-black/40 to-[#020202] p-10 shadow-4xl backdrop-blur-3xl">
                    ...
                    <div className="relative z-10 space-y-8">
                      ...
                      <p className="text-sm leading-8 text-slate-300 italic border-l-4 border-yellow-500/50 pl-8 bg-white/5 py-6 rounded-r-3xl font-medium">
                          Виявлено критичний непрямий контроль через офшорну структуру Kyoto Holdings. Ідентифіковано патерни Shadow Director (Петренко М.О.) з точністю 94.2%. � екомендується негайна ескалація до ДФСУ.
                      </p>
                    </div>
                  </div>
