...
// --- LOCALIZATION ---
const localLocales = {
  title: 'СТ� АТЕГІЧНИЙ НЕКСУС КОНКУ� ЕНТІВ',
  breadcrumbs: ['� ОЗВІДКА', 'МАТ� ИЦЯ � ИНКУ', 'v58.2.WRAITH'],
  stats: {
    database: 'БАЗА ДАНИХ',
