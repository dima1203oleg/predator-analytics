              ...
              <div className="space-y-4">
                <div className="flex items-center gap-6">
                  <span className="bg-rose-500/10 border border-rose-500/20 text-rose-500 px-5 py-1.5 text-[10px] font-black tracking-[0.4em] uppercase italic rounded-xl">
                    RISK_PROTOCOL_ELITE // COGNITIVE_SCAN
                  </span>
                ...
                <h1 className="text-7xl font-black text-white tracking-tighter uppercase italic skew-x-[-4deg] leading-none">
                  РИЗИК <span className="text-rose-600 underline decoration-rose-600/30 decoration-[16px] underline-offset-[16px] italic uppercase tracking-tighter">МОНІТОРИНГ</span>
                </h1>
                <div className="flex items-center gap-6 text-[12px] text-slate-600 font-black uppercase tracking-[0.5em] mt-8 italic border-l-4 border-rose-500/30 pl-10 opacity-95">
                  <Fingerprint size={16} className="text-rose-500" /> 
                  <span>АВТОМАТИЗОВАНЕ ВИЯВЛЕННЯ СХЕМ ТА АНОМАЛІЙ</span>
                  <span className="text-slate-900 mx-2">|</span>
                  <span className="text-rose-500 animate-pulse flex items-center gap-3 bg-rose-500/5 px-4 py-2 rounded-2xl border border-rose-500/20">
                    <Activity size={16} /> СТАТУС: ACTIVE_WATCHDOG
                  </span>
                </div>
              </div>
            </div>
                     ...
                     {loading ? (
                       ...
                       filteredEntities.map((entity) => (
                         <div 
                           ...
                           className="p-10 rounded-[4rem] bg-white/[0.01] border-2 border-white/[0.03] hover:bg-rose-500/[0.02] hover:border-rose-500/30 transition-all duration-700 group cursor-pointer relative overflow-hidden"
                         >
            ...
            <div className="col-span-12 xl:col-span-4 space-y-12">
               ...
               <div className="p-12 rounded-[5rem] bg-black border-2 border-white/[0.04] shadow-4xl space-y-12 relative overflow-hidden">
                  ...
                  <div className="space-y-6 relative z-10 pt-4 font-black">
                     {[
                       { i: Network, l: 'МАПРИЦЯ_ЗВ\'ЯЗКІВ', c: 'text-rose-500', sub: 'GRAPH_ENGINE_ANALYSIS' },
