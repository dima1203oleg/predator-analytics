...
const DEFAULT_REGIONS = [
  {
    ...
    items: [
      ...
      'Заморожені активи  Ф: €300B під управлінням ЄС',
  ...
  },
  {
    ...
    flag: '🇨🇳🇹🇼',
    color: '#D4AF37',
    category: 'ГІПЕ РИЗИК НАП УЖЕНІСТЬ',
    supplyRisk: 88,
    energyRisk: 55,
    finRisk: 68,
    items: [
      ...
      'КНД : запуск балістичного носія нового типу',
    ],
  },
  {
    id: 'me',
    ...
    items: [
      ...
      ' акетні удари по нафтовій інфраструктурі',
    ],
  },
  {
    id: 'af',
    ...
    <div className="min-h-screen text-slate-200 font-sans pb-32 relative overflow-hidden bg-[#020202]">
      ...
      <div className="relative z-10 max-w-[1850px] mx-auto p-4 sm:p-12 space-y-12">
        ...
        <ViewHeader
          ...
          breadcrumbs={['РОЗВІДКА', 'ГЕОПОЛІТИКА', ' АДА НА_СІТКА']}
          badges={[
                    ...
                    <div className="relative z-10">
                       ...
                       <div className="grid grid-cols-3 gap-8">
                          {[
                            ...
                            { label: 'ЕНЕ ГОБЕЗПЕКА', value: selectedRegion.energyRisk, icon: Flame },
                         ...
                         >
                           ...
                           <div className="flex-1 min-w-0">
                               ...
                               <div className="flex items-center gap-6 mt-4">
                                  <span className="text-[11px] font-black text-slate-800 uppercase tracking-[0.4em] italic group-hover:text-amber-500 transition-colors">КОГНІТИВНИЙ_ВПЛИВ: ВИСОКИЙ_ВЕКТО </span>
                                  <div className="h-px w-8 bg-slate-900" />
                                  <span className="text-[9px] font-black text-slate-900 tracking-widest uppercase italic">ЙМОВІ НІСТЬ: 94.2%</span>
                               </div>
                           </div>
             ...
             <div className="rounded-[3.5rem] bg-black/60 border-2 border-white/[0.04] p-10 shadow-4xl space-y-10 relative overflow-hidden group/radar">
                ...
                <div className="border-t-2 border-white/[0.04] pt-8 grid grid-cols-2 gap-8">
                   <div className="text-center group/met">
                      <p className="text-[9px] font-black text-slate-800 uppercase tracking-widest mb-2 italic">СЕ _ІНТЕНС_СКАНУ</p>
