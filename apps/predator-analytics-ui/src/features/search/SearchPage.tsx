 ...
 * 
 * Гібридний OSINT-пошук: � еєстри, Митниця, Медіа, Санкції, Graph.
 * 
                            ...
                            <div className="flex items-center gap-10">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[11px] text-slate-500 font-black uppercase tracking-[0.4em] italic opacity-80 leading-none">
                                        СЕМАНТИЧНИЙ ДВИГУН � ОЗВІДКИ • ГЛОБАЛЬНЕ Т� ЕКУВАННЯ ОБ'ЄКТІВ
                                    </p>
                                </div>
                            </div>
                        }
                        ...
                        {isSearching ? (
                            <div className="flex flex-col items-center justify-center py-40 gap-16">
                                ...
                                <div className="text-center space-y-4">
                                    <span className="text-2xl font-black text-red-600 uppercase tracking-[1em] italic animate-pulse block">АНАЛІЗ_К� ИМІНАЛЬНИХ_ВЕКТО� ІВ</span>
                                            ...
                                            <section className="relative h-full rounded-[3rem] bg-black border-2 border-white/[0.04] p-10 shadow-3xl overflow-hidden hover:border-red-600/30 transition-all flex flex-col">
                                                ...
                                                <div className="flex items-center justify-between mb-8 pb-6 border-b border-white/[0.04]">
                                                   ...
                                                   {res.severity === 'CRITICAL' && (
                                                      <span className="bg-red-600 text-white text-[9px] font-black px-4 py-1.5 rounded-full animate-pulse shadow-lg">К� ИТИЧНИЙ_� ИЗИК</span>
                                                   )}
                                                </div>
                            ...
                            <div className="flex flex-col items-center justify-center py-40 text-center gap-10">
                                ...
                                <div className="space-y-4">
                                   ...
                                   <p className="text-[11px] text-red-950/30 font-black uppercase tracking-[0.4em] italic leading-tight">П� ЕДАТО�  ПОТ� ЕБУЄ ЦІЛЬ. ІНІЦІЮЙТЕ СКАНУВАННЯ.</p>
                                </div>
                            </div>
                        )}
                    </div>
