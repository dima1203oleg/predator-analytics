        ...
        {!scanning ? (
          <div className="flex flex-col items-center">
            ...
            <div 
              ...
              } flex flex-col items-center justify-center relative transition-all duration-500 group overflow-hidden`}
            >
              ...
              {systemLoaded && !scanning && (
                <div className="absolute bottom-6 text-[9px] text-red-500/90 tracking-widest font-mono text-center px-4 bg-black/50 py-1 rounded">
