    ...
    return (
        <div className="space-y-8 p-4">
                                ...
                                >
                                    ...
                                    {node.status === 'WORKING' && (
                                        <div className="mt-5 flex items-center justify-center gap-2">
                                            ...
                                            <span className="text-[10px] text-blue-400 font-black uppercase tracking-widest">ОПЕРАЦІЯ</span>
                                        </div>
                                    )}
                                </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <TacticalCard title="КОНТРОЛЬ ПАРАЛЕЛІЗМУ" className="bg-[#0b0f1a]/80 backdrop-blur-md border-white/5" variant="holographic">
