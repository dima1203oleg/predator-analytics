    ...
    return (
        <motion.div 
            ...
            className={cn(
                ...
                isOnline ? "bg-white/5 border-white/10" : "bg-cyan-500/5 border-cyan-500/30 opacity-60"
            )}
        >
            <div className="flex items-start gap-3">
                <div className={cn(
                    ...
                    isOnline ? "bg-cyan-500/10 text-cyan-500" : "bg-rose-900/40 text-cyan-600"
                )}>
                ...
                <div>
                    ...
                    {stats && <div className="text-[8px] font-mono text-cyan-500/70 mt-2 font-black tracking-widest">{stats}</div>}
                </div>
            </div>
            ...
            <div className="absolute top-2 right-2 flex items-center gap-1.5">
                <div className={cn(
                    ...
                    isOnline ? "bg-emerald-500 shadow-emerald-500/50" : "bg-cyan-600 shadow-rose-600/50"
                )} />
        ...
        <div className="flex flex-col gap-6 p-4">
            <div className="flex items-center justify-between">
                <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2">
                    <LinkIcon size={16} className="text-cyan-500" /> ТОПОЛОГІЯ_КЛАСТЕ А_ELITE
                </h3>
                <div className="px-2 py-0.5 rounded bg-cyan-500/10 border border-cyan-500/20 text-cyan-500 text-[8px] font-black uppercase tracking-widest">
                    v58.2-ELITE
                </div>
            </div>
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex flex-col items-center gap-1">
                    <div className="p-3 rounded-full bg-slate-950 border border-cyan-500/30 text-cyan-500 ">
                        <Shield size={20} />
                    </div>
                </div>
            ...
            <div className="mt-4 p-4 rounded-xl bg-slate-950 border border-white/5 flex items-center gap-4 relative overflow-hidden group">
                ...
                <div className="px-3 py-1 rounded bg-black/40 border border-white/10 relative z-10">
                    <span className="text-[9px] font-black font-mono text-cyan-500 uppercase tracking-widest">ЗАТрИМКА: 42ms</span>
                </div>
