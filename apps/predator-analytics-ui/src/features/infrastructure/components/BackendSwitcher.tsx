    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-col items-start mr-2 relative z-10">
          <span className="text-[10px] font-black uppercase tracking-[0.2em] opacity-40 leading-none mb-1">МЕРЕЖЕВИЙ_ВУЗОЛ</span>
          ...
          >
            <div className="p-4 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
               <div className="flex flex-col">
                 <span className="text-[11px] font-black uppercase tracking-[0.3em] text-white/90 italic">ЦЕНТР_МАРШРУТИЗАЦІЇ</span>
            ...
            <div className="p-4 bg-black/40 border-t border-white/5 group/footer">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[9px] text-slate-500 leading-relaxed italic font-medium uppercase tracking-tight">
                  Адаптивна каскадна відмовостійкість: <span className="text-white/30">Sovereign ➔ Hybrid ➔ Cloud ➔ Mock</span>. Ручне перемикання фіксує вузол як пріоритетний.
                </p>
              </div>
            </div>
          </motion.div>
