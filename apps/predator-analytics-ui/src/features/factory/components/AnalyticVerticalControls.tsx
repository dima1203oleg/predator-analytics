    ...
    <TacticalCard title="АНАЛІТИЧНИЙ ІНТЕЛЕКТ" variant="cyber" className="border-amber-500/30">
      <div className="p-4 space-y-4">
        ...
        <div className="pt-4 border-t border-white/10 flex flex-col gap-3">
           <Button onClick={onOptimize} variant="neon" className="w-full bg-amber-600/20 text-amber-400 border-amber-500/50 font-black uppercase tracking-widest text-[10px] h-11"><Sparkles size={14} className="mr-2"/> Оновити Знання</Button>
