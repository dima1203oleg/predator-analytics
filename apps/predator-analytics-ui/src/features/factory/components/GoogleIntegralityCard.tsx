    ...
    <HoloCard title="ІНТЕГ АЦІЯ GOOGLE" variant="holographic" className="border-emerald-500/30 bg-emerald-500/5">
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center gap-3 p-3 rounded-2xl bg-black/40 border border-rose-500/20">
           ...
           <Badge variant="neon" className="bg-rose-500/20 text-rose-400  text-[8px]">{googleStatus.analytics.toUpperCase() === 'SYNCING' ? 'СИНХРОНІЗАЦІЯ' : googleStatus.analytics.toUpperCase()}</Badge>
        </div>
