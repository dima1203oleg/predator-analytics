  ...
  return (
    <HoloCard title="ІНТЕГ АЦІЯ GOOGLE" variant="holographic" className="border-emerald-500/30 bg-emerald-500/5">
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center gap-3 p-3 rounded-2xl bg-black/40 border border-cyan-500/20">
           <div className="w-10 h-10 rounded-xl bg-cyan-500/10 flex items-center justify-center text-rose-400">
             <BarChart3 size={20} />
           </div>
           <div className="flex-1">
           ...
           <Badge variant="neon" className="bg-cyan-500/20 text-rose-400  text-[8px]">{googleStatus.analytics.toUpperCase() === 'SYNCING' ? 'СИНХРОНІЗАЦІЯ' : googleStatus.analytics.toUpperCase()}</Badge>
        </div>
