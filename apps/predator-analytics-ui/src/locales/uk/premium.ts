...
export const premiumLocales = {
  ...
  executiveBrief: {
    ...
    ui: {
      ...
      liveData: 'ЖИВІ ДАНІ',
      footer: 'PREDATOR ANALYTICS v56.2-TITAN • NEXUS STRATEGIC CORE',
  ...
  dashboard: {
    ...
    godModeActive: 'v56.2-TITAN NEXUS РЕЖИМ БОГА АКТИВОВАНО',
  ...
  semanticRadar: {
    ...
    entityHud: {
      ...
      type: 'ТИП ОБ\'ЄКТА',
      aiInsightText: 'Об\'єкт {name} проаналізовано DeepSeek R1 та Llama 3.2. Виявлено стратегічну вразливість у секторі {type}. Рекомендується негайний аудит фінансових потоків через суверенні вузли.',
    },
  },
