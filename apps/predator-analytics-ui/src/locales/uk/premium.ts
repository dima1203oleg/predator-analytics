...
export const premiumLocales = {
        ...
        opportunities: {
          items: [
            ...
            },
            {
              ...
              summary: 'Відкрито новий логістичний коридор через  умунію',
  ...
  dashboard: {
    ...
    dynamics: {
      title: 'ДИНАМІКА СИСТЕМИ',
      subtitle: 'Трасування Затримки та Продуктивності',
      market: ' ИНОК',
      engine: 'ДВИГУН'
    },
    agents: {
      ...
      initializing: 'Ініціалізація колективного інтелекту...'
    }
  },
  ...
  modeling: {
    ...
    scenarios: {
      ...
      optimistic: { name: 'Оптимістичний  іст', desc: ' іст ринку +15%' },
  ...
  common: {
    ...
    errorFetchingData: 'Помилка отримання даних',
  ...
  operationalAnalytics: {
    ...
    subtitle: 'КО ПО АТИВНА АНАЛІТИКА •  ЕАЛЬНИЙ ЧАС • 100% ТОЧНІСТЬ',
    updated: 'Оновлено',
  ...
  semanticRadar: {
    ...
    entityHud: {
      ...
      type: 'ТИП ОБ\'ЄКТА',
      aiInsightText: 'Об\'єкт {name} проаналізовано DeepSeek R1 та GLM-5.1 Agentic Pool. Виявлено стратегічну вразливість у секторі {type}. рекомендується негайний аудит фінансових потоків через суверенні вузли.',
    },
  },
  ...
  monitoring: {
    ...
    maintenance: {
      title: 'КЕ УВАННЯ ОБСЛУГОВУВАННЯМ ШІ',
      vacuum: {
  ...
  omniscience: {
    ...
    insight: {
      title: 'СТРАТЕГІЧНИЙ ІНСАЙТ ЯД А',
    ...
    telemetry: {
      title: 'ЖИВА ТЕЛЕМЕТ ІЯ V45',
      secureChannel: 'ЗАХИЩЕНИЙ КАНАЛ // PREDATOR-SIGMA-V45',
      statusVerified: 'СТАТУС: ВЕ ИФІКОВАНО',
      hash: 'ХЕШ',
    }
  },
  ...
  evolution: {
    ...
    trace: {
      ...
      decisionApproved: ' ішення Погоджено',
    ...
    ledgerView: {
      ...
      networkActive: 'AZR_МЕ ЕЖА_АКТИВНА',
    },
    forgeView: {
  ...
  onboarding: {
    steps: {
      ...
      documents: {
        title: ' озумний Аналіз Документів',
  ...
  visualAnalytics: {
    ...
    labels: {
      situational: 'СИТУАЦІЙНІ Т ЕНДИ v2.4',
      segmentation: 'АНАЛІЗ СЕГМЕНТАЦІЇ  ИНКУ',
      flows: 'ГЕОПОЛІТИЧНІ ТО ГОВІ ПОТОКИ',
  ...
  macroIndicators: {
    ...
    subtitle: 'Контекст Глобального  инку',
  ...
  reportCenter: {
    ...
    templates: {
      ...
      gap: {
        name: 'Аналіз Конкурентного  озриву',
  ...
  signalsFeed: {
    ...
    initial: {
      ...
      priceArbitrage: {
        title: 'Арбітраж Ціни',
        desc: ' ізниця ціни на сталь між Туреччиною та Польщею досягла 12%.',
      }
    }
  },
  ...
  smartCalculator: {
    title: ' озумний Калькулятор',
    subtitle: ' озрахунок митних платежів',
    customsValue: 'Митна Вартість',
    country: 'Країна',
    calculate: ' озрахувати',
    duty: 'Мито',
    vat: 'ПДВ',
    total: ' азом',
    hsCode: 'Код УКТ ЗЕД',
  ...
  competitorWarBoard: {
    ...
    subtitle: 'Домінування на ринку та Тактична  озвідка',
    aiActive: 'AI АКТИВНО',
    marketLabel: ' инок',
    riskLabel: ' изик',
    riskLevels: {
    ...
    latestIntelligence: 'Останні Дані  озвідки',
    aiForecast: 'Прогноз ШІ',
    marketConsolidationForecast: 'Ймовірна консолідація ринку',
    fullGapAnalysis: 'Повний Аналіз  озривів  инку',
  },
  ...
  predatorChat: {
    ...
    riskResponse: "Сканую поточні операції...  изик по компанії 'ТОВ Вектор' підвищено до 89%.",
  ...
  predictiveModeling: {
    title: 'Предиктивне Моделювання  инку',
      ...
      SOVEREIGN: {
        ...
        leads: {
          grain: {
            ...
            desc: ' озрахункові втрати митних зборів від "чорного експорту" зерна складають $12M за місяць.',
          },
          energy: {
    ...
    persona: {
      ...
      titan: {
        ...
        features: {
          ...
          priceIntel: 'Цінова  озвідка',
          priceIntelDesc: 'реальні ціни vs декларовані',
        }
      },
      inquisitor: {
        title: 'Контрольна  озвідка',
