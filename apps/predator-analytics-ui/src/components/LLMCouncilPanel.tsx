...
export const LLMCouncilPanel: React.FC<LLMCouncilPanelProps> = ({ isLockdown }) => {
    ...
    const handleStrategicAnalysis = async () => {
        ...
        setError(null);
        setResult(null);
        setQuery("Strategic Autonomous Analysis_v61.0-ELITE_Initiated...");
                        ...
                        {!result && !isDeliberating && (
                            ...
                            >
                                ...
                                <div className="mt-20 text-center relative z-10">
                                    ...
                                    <p className="text-[11px] text-slate-600 font-black uppercase tracking-[0.5em] max-w-sm mx-auto leading-loose opacity-60">Очікування ініціалізації нейронного ланцюга арбітражу знань v61.0-ELITE.</p>
                                </div>
                            </motion.div>
                        )}
