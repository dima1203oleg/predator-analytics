        ...
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="relative flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                <span className="text-[10px] text-emerald-400 font-black uppercase tracking-widest">Стабільна Робота</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-12 lg:col-span-5 p-8 bg-slate-900/40 border border-white/5 rounded-[40px] shadow-2xl backdrop-blur-3xl relative overflow-hidden group">
                    ...
                    <div className="relative flex items-center gap-6">
                        ...
                        <div>
                            <div className="text-[10px] text-slate-500 font-black uppercase tracking-[0.3em] mb-1">ТАРГЕТ-ВЕРСІЯ (AZR_AUTO)</div>
                            <div className="text-4xl font-black text-white font-mono tracking-tighter">
                                {targetVersion}
                            </div>
                            <div className="flex items-center gap-2 mt-2">
            ...
            <div className="p-10 bg-black/40 border border-white/5 rounded-[48px] shadow-2xl backdrop-blur-3xl relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-12">
                    <div>
                        <h3 className="text-2xl font-black text-white uppercase tracking-tighter">ЦЕНТРАЛЬНИЙ МОНІТОР РОЗГОРТАННЯ</h3>
                    ...
                    {!isDeploying ? (
                        ...
                        <div className="flex items-center gap-6">
                            <div className="text-right">
                                <div className="text-[10px] text-slate-500 font-black uppercase mb-1">ПРОГРЕС</div>
