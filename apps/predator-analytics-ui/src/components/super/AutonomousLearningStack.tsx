...
export const AutonomousLearningStack: React.FC = () => {
    ...
    return (
        <TacticalCard
            title="Sovereign Learning Stack"
            ...
            <div className="space-y-4">
                ...
                <div className="bg-white/5 p-3 rounded-xl border border-white/10">
                    <div className="flex justify-between items-center mb-2">
                        <span className="text-[10px] text-white/40 uppercase font-mono">Current Engine Status</span>
                    ...
                    <p className="text-xs text-white/80 font-mono mb-2">
                        {trainingStatus?.message || "Очікування нових патернів..."}
                    </p>
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    >
                        ...
                        <span className="text-[10px] font-bold text-orange-400 uppercase">Plus Data</span>
                    </button>
                    <button className="flex items-center justify-center gap-2 p-2 bg-blue-500/10 border border-blue-500/30 rounded-lg hover:bg-blue-500/20 transition-all opacity-50 cursor-not-allowed">
                        ...
                        <span className="text-[10px] font-bold text-blue-400 uppercase">Tune Hyper</span>
                    </button>
                </div>
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        <span className="text-[10px] text-white/40 uppercase font-mono">Model Accuracy Delta</span>
                        <TrendingUp className="w-3 h-3 text-green-400" />
                    </div>
                    {history.slice(0, 3).map((job, i) => (
