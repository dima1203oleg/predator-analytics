      ...
      <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-4">
        ...
        <div className="flex items-start gap-4">
          <motion.div
            ...
            className="p-3 bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl border border-slate-700/50 shadow-[inset_0_0_20px_rgba(0,0,0,0.2)] text-primary-500 shrink-0 relative overflow-hidden group"
          >
