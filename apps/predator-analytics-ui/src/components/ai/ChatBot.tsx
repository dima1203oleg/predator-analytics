      ...
      <div className={cn(
        ...
        <div className="p-5 border-t border-white/5 bg-slate-950/40">
          ...
          <div className="mt-4 flex items-center justify-between opacity-30 px-1">
            ...
            <div className="text-[10px] font-mono tracking-tighter uppercase font-bold text-primary/60">PREDATOR AI ENGINE v56.2-TITAN</div>
          </div>
        </div>
      </div>
    </>
