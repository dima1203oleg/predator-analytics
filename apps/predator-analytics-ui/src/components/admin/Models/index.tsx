  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         ...
         <div className="bg-slate-900/50 border border-blue-500/20 rounded-xl p-6 relative overflow-hidden bg-gradient-to-br from-blue-900/10 to-transparent">
         ...
         <div className="bg-slate-900/50 border border-cyan-500/20 rounded-xl p-6 relative overflow-hidden bg-gradient-to-br from-cyan-900/10 to-transparent">
