...
const AssetMap = () => (
    <div className="relative w-full h-[250px] bg-slate-950/80 rounded-lg border border-slate-800  group panel-3d">
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in duration-500">
            ...
            <div className="lg:col-span-12 grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-4 rounded-xl border border-slate-800 shadow-lg relative  group panel-3d">
