...
import { Terminal, Cpu, Database, Network, Search, Zap, Activity, X } from 'lucide-react';
    ...
    <AnimatePresence>
      {isTerminalOpen && (
        <motion.div 
          ...
          exit={{ opacity: 0, y: 20 }}
          className="bg-[#050505] border border-white/5 rounded-[2rem] overflow-hidden flex flex-col h-full shadow-2xl relative group"
        >
          ...
          <div className="flex items-center justify-between px-8 py-5 border-b border-white/5 bg-white/[0.02]">
            ...
            <div className="flex items-center gap-4">
              ...
              <button 
                ...
                className="p-1 hover:bg-white/5 rounded-lg transition-all text-slate-500 hover:text-rose-500"
              >
                <X size={16} />
              </button>
            </div>
          ...
          <div className="px-8 py-4 border-t border-white/5 bg-black/40 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-rose-500">
              <Zap size={12} />
              <span className="text-[8px] font-black uppercase tracking-[0.2em] italic">WRAITH_ENGINE v58.2</span>
            </div>
          </div>
        </motion.div>
      )}
