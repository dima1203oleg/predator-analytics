...
/**
 * PREDATOR OSINT-Контур v58.2-WRAITH | Constitutional Shield
...
export const ConstitutionalShield: React.FC = () => {
    ...
    useEffect(() => {
        const fetchStatus = async () => {
            try {
                // AZR статус — суверенний щит v58.2-WRAITH
                ...
                console.warn("Constitutional Shield v58.2-WRAITH (FALLBACK_MODE):", error);
        ...
        fetchStatus();
        const interval = setInterval(fetchStatus, 15000); // More frequent in v58.2-WRAITH
            ...
            >
                ...
                <div className="absolute -right-2 top-0 translate-x-full opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
                    <div className="bg-slate-900/90 border border-blue-500/30 px-3 py-1 rounded-r-lg backdrop-blur-md">
                        <span className="text-[8px] font-black text-blue-400 uppercase tracking-widest whitespace-nowrap">CONSTITUTIONAL_GUARD_v58.2-WRAITH</span>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <div className="p-6 bg-gradient-to-br from-blue-600/20 to-transparent border-b border-white/5">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 className="text-[11px] font-black text-white uppercase tracking-[0.2em]">OSINT-Контур v58.2-WRAITH</h4>
                            ...
                            <div className="px-6 py-4 bg-black/40 flex items-center justify-between border-t border-white/5">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[8px] font-mono text-slate-500 uppercase">Sentinel v58.2-WRAITH.0-СТАБІЛЬНО</span>
                                </div>
