 ...
 * Використовує стабільну темну оболонку, щоб не ламати tactical UI сторінок.
 */
export const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 opacity-35 [background-image:linear-gradient(rgba(148,163,184,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,0.07)_1px,transparent_1px)] [background-size:64px_64px]" />
