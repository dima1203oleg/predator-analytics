...
import { useTranslation } from 'react-i18next'; // Assuming i18n is setup, otherwise direct strings
...
const AzrHyperWidget: React.FC = () => {
    ...
    return (
        <HoloContainer className={`relative flex items-center justify-between p-4 mb-6 pt-10 overflow-hidden border ${borderColor} transition-colors duration-500`}>
