/**
 * 🛰️ OSINT COMMAND CENTER (v57.2-WRAITH REFACTORED)
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-black tracking-tighter text-white flex items-center gap-2">
                            ...
                            <span className="text-[10px] bg-rose-500/20 text-rose-400 px-2 py-0.5 rounded-full border border-rose-500/30 font-mono">v57.2-WRAITH</span>
                        </h1>
            ...
            <footer className="fixed bottom-0 left-0 right-0 h-10 bg-slate-950/80 backdrop-blur-md border-t border-slate-800/50 flex items-center justify-between px-8 text-[10px] z-50">
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-400 font-bold uppercase tracking-wider">Роутер: http://localhost:4000 (ПІДКЛЮЧЕНО)</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-4 font-mono text-slate-500 uppercase font-black">
                    <span>Регіон: UA_EAST_CLSTR_01</span>
