...
describe('Компоненти Card (Shadcn UI)', () => {
    test('повинні відмальовувати зібрану картку з усіма секціями (включаючи український текст)', () => {
        // Рендеримо повну структуру картки OSINT
        render(
            <Card data-testid="osint-card">
                <CardHeader>
                    <CardTitle>Аналітика Ризиків</CardTitle>
                ...
                <CardContent>
                    ...
                    <p>Ризик транзакцій перевищує норму на 14%</p>
                </CardContent>
                <CardFooter>
        ...
        const titleElement = screen.getByText('Аналітика Ризиків')
        ...
        // Перевіряємо контент
        const contentText = screen.getByText('Ризик транзакцій перевищує норму на 14%')
