    ...
    return (
        ...
        >
            ...
            <div className="lg:col-span-2 space-y-8">
                <TacticalCard variant="holographic" title="TEXT-TO-SQL RLHF CALIBRATION v56.5-ELITE" className="panel-3d group">
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-4 mt-3">
                                            ...
                                            <span className="text-[10px] font-mono text-blue-400 uppercase tracking-widest flex items-center gap-1.5"><div className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" /> LoRA: Active_v56.5-ELITE</span>
                                        </div>
                                    </div>
                                </div>
