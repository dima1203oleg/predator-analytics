    ...
    if (buckets.length === 0) {
        return (
            ...
            >
                ...
                <p className="mt-3 text-sm font-black uppercase tracking-[0.3em] text-slate-300">НЕМАЄ ПІДТВЕРДЖЕНИХ BUCKET-ІВ</p>
                                ...
                                <div className="flex items-center gap-5">
                                    <div className={cn(
                                        ...
                                        <div>
                                            ...
                                            <span className="text-[10px] text-slate-600 font-mono">ПІДТВЕРДЖЕНИЙ BUCKET</span>
                                            </div>
                                        </div>
                                    </div>
                                <div className={cn(
