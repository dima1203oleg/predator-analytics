            ...
            <div className="flex-1 space-y-10 overflow-y-auto no-scrollbar">
                <div className="grid grid-cols-2 gap-6">
                    <div className="p-6 bg-black/40 border border-white/5 rounded-[2rem]">
                        <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2">� ІВЕНЬ � ИЗИКУ</p>
            ...
            <div className="min-h-screen bg-[#020202] text-slate-200 relative overflow-hidden font-sans pb-40">
                ...
                <div className="relative z-10 max-w-[1900px] mx-auto p-4 sm:p-8 lg:p-12 space-y-12">
                    ...
                    <ViewHeader
                        ...
                        breadcrumbs={['ЯД� О', 'Г� АФОВА_МАТ� ИЦЯ', 'STRATEGIC_OSINT']}
                    />
                            ...
                            >
                                ...
                                <div className="absolute inset-0 z-0">
                                     ...
                                     {isLoading ? (
                                         ...
                                         <div className="w-full h-full relative cursor-crosshair overflow-hidden" onClick={() => setSelectedNode({ id: '1234', label: 'УК� -ОБО� ОН-ЕКСПО� Т', type: 'COMPANY', val: 100, risk: 0.88 })}>
                                             ...
                                             {[
                                                 ...
                                                 { pos: 'top-[30%] left-[80%]', icon: Target, color: 'text-rose-400', label: '� ИЗИК-ФАКТО� ' },
                                             ...
                                             <div className="absolute bottom-10 left-10 z-20 flex gap-8 items-center bg-black/40 backdrop-blur-3xl p-6 rounded-[2rem] border border-white/5 shadow-2xl">
                                                 ...
                                                 <div className="flex items-center gap-3">
                                                     ...
                                                     <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">ВИСОКИЙ � ИЗИК</span>
                                                 </div>
                                             </div>
                                         </div>
                                     )}
                                ...
                                <HoloContainer className="p-10 h-[450px] relative overflow-hidden group">
                                     <div className="flex items-center justify-between mb-8">
                                         <div className="flex items-center gap-4">
                                             ...
                                             <h3 className="text-sm font-black text-white uppercase tracking-[0.4em] italic leading-none">СТ� АТЕГІЧНИЙ_АНАЛІЗ_v62</h3>
                                         </div>
                                     ...
                                     <div className="space-y-6 flex-1 overflow-y-auto no-scrollbar pr-4">
                                         {[
                                            ...
                                            { label: '� ИЗИК_КОНТАМІНАЦІЇ', val: 0.45, color: 'bg-amber-500' },
                                ...
                                <TacticalCard variant="cyber" className="p-10 h-[450px] border-indigo-500/20 relative overflow-hidden group/ops">
                                     <div className="flex items-center justify-between mb-10">
                                         <div className="flex items-center gap-4">
                                             ...
                                             <h3 className="text-sm font-black text-white uppercase tracking-[0.4em] italic leading-none">ЛОГ_Г� АФОВИХ_ОПЕ� АЦІЙ</h3>
                                         </div>
                                     ...
                                     <div className="space-y-6 font-mono text-[11px] flex-1 overflow-y-auto no-scrollbar pr-4 text-emerald-500/80 italic">
                                         ...
                                         <p className="border-l border-white/10 pl-4 py-1 hover:text-white transition-colors">{">> "} ВИЯВЛЕНО П� ИХОВАНУ ОБЛАСТЬ ЗВ'ЯЗКІВ L2</p>
