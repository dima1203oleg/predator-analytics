                                           ...
                                           <div className="relative w-full h-full flex items-center justify-center">
                                               ...
                                               <div className="absolute bottom-6 left-10 right-10 flex justify-between items-end">
                                                   <div className="space-y-4">
                                                       <h4 className="text-[9px] font-black text-red-600 uppercase tracking-[0.4em] italic leading-none">СТАБІЛЬНІСТЬ_ЯДРА</h4>
                                   ...
                                   <div className="space-y-10">
                                       ...
                                       <div className="bg-[#0a0a0a]/60 backdrop-blur-3xl border border-white/5 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                                           <div className="flex items-center justify-between mb-6">
                                               <h4 className="text-[10px] font-black text-red-600 uppercase tracking-[0.4em] italic">ГЕОПРОСТОРОВИЙ_СКАНЕР</h4>
