 ...
 * СТ� АТЕГІЧНИЙ_ЗАХИСТ_� ЕСУ� СІВ: Управління навантаженням та VRAM.
 */
        ...
        <div className="flex flex-col gap-3 border-l-4 border-rose-500 pl-10 py-2">
          ...
          <div className="flex items-center gap-8 text-[11px] font-black font-mono text-white/30 tracking-[0.2em] uppercase italic">
            ...
            <div className="flex items-center gap-3 text-rose-500/40">
               <Shield size={14} />
               <span>� ІВЕНЬ_ГА� ДУ: ELITE_WRAITH_v3</span>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-10">
          <div className="space-y-8">
            <div className="flex items-center gap-6 px-4">
               ...
               <span className="text-[12px] font-black font-mono text-white/40 uppercase tracking-[0.5em] italic glint-elite">� ОЗПОДІЛ_VRAM_8GB_GUARD</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-wraith p-10 rounded-[3rem] border-2 border-white/5 relative overflow-hidden group hover:border-emerald-500/40 transition-all duration-1000 shadow-4xl">
               ...
               <div className="flex items-center justify-between mb-8 relative z-10">
                  <div className="flex flex-col">
                     <span className="text-[10px] font-black font-mono text-emerald-500/60 uppercase tracking-[0.4em] italic mb-2">ГЛОБАЛЬНИЙ_МАЙСТЕ� </span>
               ...
               >
                 ...
                 {llmTriStateMode === 'HYBRID' ? 'ПОТОЧНИЙ_МАЙСТЕ� _АКТИВНИЙ' : 'АКТИВУВАТИ_HYBRID_ENGINE'}
               </button>
            </div>
