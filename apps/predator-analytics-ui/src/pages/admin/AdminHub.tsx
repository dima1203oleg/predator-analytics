...
const TABS: TabConfig[] = [
  ...
  { id: 'risk-admin',   category: 'BUSINESS_INTEL', label: '� ИЗИКИ_ПО� ТФЕЛЯ', badge: 'ФІН',    icon: PieChart,      component: PortfolioRiskView },
  ...
  { id: 'ai-engines',   category: 'AI_LAB', label: 'ДВИГУНИ_ШІ',   badge: 'ЯД� О',     icon: Cpu,           component: EnginesView },
  ...
  { id: 'intelligence', category: 'INTEL_OSINT', label: '� ОЗВІДКА',     badge: 'П� ИВИД',   icon: Eye,           component: CustomsIntelligenceView },
  ...
  { id: 'aml',          category: 'INTEL_OSINT', label: 'СКО� ИНГ_АМЛ',   badge: '� ИЗИК',     icon: Activity,      component: AMLScoringView },
  { id: 'sanctions',    category: 'INTEL_OSINT', label: 'САНКЦІЇ',       badge: 'ГЛОБАЛЬНО',   icon: Lock,          component: SanctionsScreening },
  { id: 'conv-intel',   category: 'INTEL_OSINT', label: 'СОЦ_� ОЗВІДКА', badge: 'СОЦІАЛЬНО',   icon: MessageSquare, component: ConversationIntelView },
        ...
        <div className="flex items-center gap-20">
          ...
          <div className="flex items-center gap-16 border-l-2 border-white/5 pl-16 h-16">
            ...
            <div className="flex flex-col border-l-2 border-white/5 pl-16 h-14 justify-center group/threat">
              <span className="text-white/20 text-[9px] leading-none mb-4 tracking-[0.5em] font-black italic group-hover/threat:text-rose-500 transition-colors uppercase">� ІВЕНЬ_ЗАГ� ОЗИ_L7</span>
              <div className="flex items-center gap-6">
                <div className="relative">
                ...
                <div className="flex flex-col">
                  <span className={cn("font-black text-2xl tracking-tighter italic leading-none glint-elite", threatLevel > 70 ? "text-rose-500" : "text-white/70")}>
                    {threatLevel.toFixed(0)}% <span className="text-[10px] opacity-40 ml-2 not-italic font-black">� ИЗИК</span>
                  </span>
...
const TabNav: React.FC<TabNavProps> = ({ activeTab, onTabChange }) => {
  ...
  const CATEGORIES: { id: TabCategory; label: string; subLabel: string; icon: any; color: string }[] = [
    ...
    { id: 'SYSTEM_CORE', label: 'ЯД� О_СИСТЕМИ', subLabel: 'ІНФ� АСТ� УКТУ� А_&_CONTROL', icon: Shield, color: 'rose' },
    { id: 'AI_LAB',      label: 'AI_ЛАБО� АТО� ІЯ', subLabel: 'НАВЧАННЯ_&_АВТОЗАВОД', icon: BrainCircuit, color: 'rose' },
    { id: 'INTEL_OSINT', label: '� ОЗВІДКА_&_OSINT', subLabel: 'ГЛОБАЛЬНИЙ_АНАЛІЗ_L7', icon: Eye, color: 'rose' },
