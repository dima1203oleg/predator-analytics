          ...
          <div className="flex-1 space-y-6">
            <div className="flex flex-wrap items-center gap-3">
              <div className="badge-v2 badge-v2-red">
                <span className="relative z-10 text-white font-black italic">PREDATOR v57.2-WRAITH | SOVEREIGN MARKET</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="flex items-center gap-3 p-4 rounded-2xl border border-slate-500/10 bg-slate-500/5 group hover:border-slate-500/30 transition-all">
          ...
          <div>
            ...
            <div className="text-xs font-bold text-slate-200 uppercase italic">Активність_Ядра (v57.2-WRAITH)</div>
          </div>
        </div>
