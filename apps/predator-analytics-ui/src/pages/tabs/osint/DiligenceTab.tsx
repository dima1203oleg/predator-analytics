                        ...
                        <div className="flex gap-1.5 overflow-x-auto hide-scrollbar py-1 -mx-2 px-2">
                            {riskFilters.map(filter => (
                                <button 
                                    ...
                                    className={cn(
                                        "px-3.5 py-2 rounded-full text-[9px] font-black uppercase tracking-widest transition-all shrink-0 border",
                                        riskFilter === filter.value 
                                            ? "bg-rose-600 text-white border-rose-500 shadow-[0_0_10px_rgba(244,63,94,0.2)]" 
