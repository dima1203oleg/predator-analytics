        ...
        <div className="flex-1 flex flex-col justify-center space-y-12">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="space-y-4 text-center lg:text-left">
              <div>
                <p className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] mb-2 italic">КІНЦЕВИЙ_ВЕРДИКТ</p>
                <p className="text-4xl font-black italic text-white tracking-tighter leading-none uppercase">ВИСОКА_ЙМОВІРНІСТЬ</p>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              { label: 'ТОПОЛОГІЯ_РИЗИКУ', value: 'КЛАСТЕР_АЛЬФА_IX', icon: Network, color: '#10b981' },
