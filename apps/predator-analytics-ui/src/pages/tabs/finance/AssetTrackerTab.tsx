        ...
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full text-left border-collapse">
            <thead className="bg-white/[0.02]">
              <tr>
                {['ОБ\'ЄКТ_ВЛАСНОСТІ', 'СУМА', 'ДАТА', 'ОРГАН', 'СТАТУС'].map(h => (
                ...
                <tr key={i} className="border-b border-white/[0.02] hover:bg-emerald-950/20 transition-all cursor-pointer group/row relative overflow-hidden">
                  ...
                  <td className="px-10 py-8 relative z-10">
                    <div className="flex items-center gap-3">
                      <div className={cn("w-2 h-2 rounded-full shadow-lg", asset.status === 'ЗАМОРОЖЕНО' ? "bg-emerald-600 animate-pulse shadow-emerald-900/50" : "bg-cyan-600 shadow-cyan-900/50")} />
