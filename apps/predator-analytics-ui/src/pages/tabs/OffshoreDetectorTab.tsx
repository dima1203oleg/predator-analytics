...
const MOCK_OFFSHORE = [
  { name: 'БРИТ. ВІРГ. О-ВИ', value: 38, amount: '$142.5M', color: '#10b981' },
  { name: 'КІПР', value: 27, amount: '$98.2M',  color: '#059669' },
