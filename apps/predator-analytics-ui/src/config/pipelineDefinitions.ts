...
export const STAGE_LIBRARY: Record<string, PipelineStageDef> = {
    ...
    OCR: { id: 'OCR', label: 'OCR', icon: Layers, color: '#22d3ee', description: 'Розпізнавання тексту' },
    ...
    LOAD_SQL: { id: 'LOAD_SQL', label: 'PostgreSQL', icon: Database, color: '#22c55e', description: 'Реляційне сховище' },
