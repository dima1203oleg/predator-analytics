...
const baseNavigationConfig: NavSection[] = [
  {
    ...
    items: [
      ...
      {
        id: 'monitoring',
        label: 'Оперативний моніторинг',
        path: '/monitoring',
        icon: Activity,
        description: 'Живі стани сервісів, черг, подій та деградацій в єдиному центрі контролю.',
        group: 'Оперативний огляд',
        priority: 92,
        matchPaths: ['/dashboards', '/realtime/dashboard'],
      },
      {
        id: 'portfolio-risk',
      ...
      },
      {
        ...
        path: '/morning-brief',
        icon: Compass,
        description: 'Щоденна аналітична вижимка: головні події, за якими варто стежити сьогодні.',
        group: 'Стратегічний контроль',
        priority: 90,
      },
      {
        ...
        path: '/radar',
        icon: Radar,
        description: 'Візуалізація геополітичних, економічних та безпекових сигналів у реальному часі.',
        group: 'Стратегічний контроль',
        priority: 88,
        matchPaths: ['/geopolitical-radar'],
      },
      {
        id: 'war-room',
        label: 'Ситуаційний центр (War Room)',
        path: '/war-room',
        icon: Radio,
        description: 'Координація у реальному часі, ескалація інцидентів та спільна робота над кризами.',
        group: 'Стратегічний контроль',
        priority: 85,
      },
    ],
  ...
  {
    id: 'intelligence',
    label: 'OSINT ТА РОЗВІДКА',
    description: 'Центральний хаб пошуку: досьє, бенефіціари, PEP, санкції, граф зв’язків.',
    outcome: 'Decision Advantage: Глибоке розуміння будь-якого суб’єкта чи мережі за лічені хвилини.',
    accent: 'amber',
    items: [
      {
        id: 'search',
        label: 'Пошуковий центр (Omni)',
        path: '/search',
        icon: Search,
        description: 'Гібридний пошук по реєстрах, індексах та відкритих джерелах у єдиному вікні.',
        group: 'Інструменти розвідки',
        priority: 100,
        matchPaths: ['/search-smart', '/search-v2', '/companies-cers'],
      },
      {
        id: 'dossier',
        label: 'Досьє та бенефіціари',
        path: '/dossier',
        icon: Network,
        description: 'Повний аналіз субʼєкта: UBO-карта, PEP-статус, звʼязки та репутація.',
        group: 'Інструменти розвідки',
        badge: 'SUPER-VIEW',
        priority: 98,
        matchPaths: ['/ubo-map', '/pep-tracker', '/diligence', '/compromat-firm', '/compromat-person', '/shadow-director'],
      },
      {
        id: 'graph',
        label: 'Граф звʼязків',
        path: '/graph',
        icon: Network,
        description: 'Візуальний аналіз сутностей, бенефіціарів та прихованих кластерів.',
        group: 'Глибокий аналіз',
        priority: 94,
      ...
      },
      {
        ...
        path: '/zrada-control',
        icon: ShieldX,
        description: 'Моніторинг субʼєктів із критичним ризиком лояльності та держзради.',
        group: 'Глибокий аналіз',
        badge: 'ELITE',
        priority: 96,
      },
      {
        id: 'registries',
        label: 'Реєстри та документи',
        path: '/registries',
        icon: Database,
        description: 'Консолідований доступ до державних реєстрів та архіву документів.',
        group: 'Дані та архіви',
        priority: 90,
        matchPaths: ['/documents', '/datagov'],
      },
      {
        id: 'tenders',
        label: 'Тендерна розвідка',
        path: '/tenders',
        icon: Briefcase,
        description: 'Аналіз закупівель, аномальних переможців та корупційних звʼязків.',
        group: 'Дані та архіви',
        priority: 88,
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 'financials',
        label: 'Фінансова розвідка (SIGINT)',
        path: '/financials',
        icon: Landmark,
        description: 'Контроль транзакцій, офшорних структур та банківських ризиків (SWIFT/SEPA).',
        group: 'Транзакційний контур',
        priority: 100,
        matchPaths: ['/swift-monitor', '/offshore-detector', '/financial-sigint', '/contract-price-check', '/asset-freeze-tracker'],
      },
      {
        id: 'sanctions',
        label: 'Санкційне право',
        path: '/sanctions',
        icon: Scale,
        description: 'Перевірка санкційних списків, активів та механізмів обходу обмежень.',
        group: 'Комплаєнс',
        priority: 94,
      },
      {
        ...
        path: '/aml',
        icon: AlertTriangle,
        description: 'Автоматична оцінка ризиків відмивання коштів та підозрілих потоків.',
        group: 'Комплаєнс',
        priority: 92,
      },
    ],
    ...
    items: [
      {
        ...
        path: '/customs',
        icon: Shield,
        description: 'Контроль декларацій, товарних потоків та ризикових категорій ЗЕД.',
        group: 'ЗЕД та Логістика',
        priority: 95,
        matchPaths: ['/customs-intel', '/customs-premium'],
      },
      {
        id: 'supply-chain',
        label: 'Ланцюги постачання',
        path: '/supply-chain',
        icon: Box,
        description: 'Digital Twin логістики: відстеження маршрутів та вузлів ризику.',
        group: 'ЗЕД та Логістика',
        priority: 90,
      },
      {
        ...
        path: '/maritime',
        icon: Ship,
        description: 'Моніторинг суден, портів та транзитних морських коридорів.',
        group: 'ЗЕД та Логістика',
        priority: 85,
      },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'oracle',
        label: 'Sovereign Oracle (Intel Hub)',
        path: '/oracle',
        icon: Zap,
        description: 'Прямий доступ до синтезованого інтелекту та стратегічного прогнозування.',
        group: 'Автономний контур',
        badge: 'v58.2-WRAITH',
        priority: 95,
      },
...
export const itemMatchesPath = (item: NavItem, pathname: string): boolean => {
  ...
  return item.matchPaths?.some((matchPath) => pathname === matchPath || pathname.startsWith(`${matchPath}/`)) ?? false;
};
