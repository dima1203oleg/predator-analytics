...
- Name: views.spec.ts >> Agents View >> should display agents list
- Location: e2e/views.spec.ts:42:3
...
Call log:
  - navigating to "https://229hrqqh1vcj.share.zrok.io/agents", waiting until "load"
