...
- Name: rbac-scenarios.spec.ts >> 🔴 СЦЕНАРІЙ 3: Тестування ролі VIP (Рівень 3) >> 3.2 Аудит ELITE-модулів: завантаження даних
- Location: e2e/rbac-scenarios.spec.ts:263:3
