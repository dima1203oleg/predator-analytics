...
Call log:
  - waiting for locator('text=ОПЕРАТИВНИЙ ОФІЦЕР') to be visible
    - locator resolved to visible <div class="text-lg font-black tracking-[0.2em] text-white group-hover:text-slate-200 transition-colors duration-300">ОПЕРАТИВНИЙ ОФІЦЕР</div>
