...
- Name: rbac-scenarios.spec.ts >> 🟡 СЦЕНАРІЙ 2: Тестування ролі PRO (Рівень 2) >> 2.1 Аудит Функціоналу: доступність аналітичних модулів
- Location: e2e/rbac-scenarios.spec.ts:184:3
