...
- Name: rbac-scenarios.spec.ts >> 🛡️ СЦЕНАРІЙ 4: Тестування ролі ADMIN (Рівень 4) >> 4.1 Аудит Ізоляції: навігація повністю змінена
- Location: e2e/rbac-scenarios.spec.ts:342:3
...
- generic [ref=e6]:
  ...
  - generic [ref=e516]:
    - generic [ref=e519]:
      - generic [ref=e520]:
        - img [ref=e521]
        - generic [ref=e523]: Крок 1 з 6
      - button "Закрити" [ref=e524] [cursor=pointer]:
        - img [ref=e525]
    - generic [ref=e528]:
      - img [ref=e530]
      - heading "Ласкаво просимо до Predator v45 | Neural Analytics" [level=2] [ref=e535]
      - paragraph [ref=e536]: Ваша ультимативна платформа для аналітики, розслідувань та стратегічного планування тепер ще потужніша.
    - generic [ref=e537]:
      - button "Назад" [disabled] [ref=e538]
      - button "Далі" [ref=e546] [cursor=pointer]:
        - text: Далі
        - img [ref=e547]
