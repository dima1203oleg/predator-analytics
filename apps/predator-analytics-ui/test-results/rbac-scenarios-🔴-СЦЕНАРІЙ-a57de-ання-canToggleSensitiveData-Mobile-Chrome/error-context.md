...
- Name: rbac-scenarios.spec.ts >> 🔴 СЦЕНАРІЙ 3: Тестування ролі VIP (Рівень 3) >> 3.4 Тест Функції Перемикання: canToggleSensitiveData
- Location: e2e/rbac-scenarios.spec.ts:295:3
...
Call log:
  - waiting for locator('text=DRPO-ДИРЕКТОР') to be visible
