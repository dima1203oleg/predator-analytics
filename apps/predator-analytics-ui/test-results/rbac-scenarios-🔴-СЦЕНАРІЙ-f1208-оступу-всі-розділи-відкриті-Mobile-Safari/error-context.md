...
- Name: rbac-scenarios.spec.ts >> 🔴 СЦЕНАРІЙ 3: Тестування ролі VIP (Рівень 3) >> 3.1 Аудит Повного Доступу: всі розділи відкриті
- Location: e2e/rbac-scenarios.spec.ts:249:3
...
- generic [ref=e7]:
  ...
  - generic [ref=e15]:
    - generic [ref=e16]: ЦЕНТРАЛЬНЕ_ЯДРО_КИЇВ
    - generic [ref=e17]:
