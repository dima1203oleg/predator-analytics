...
- Name: views.spec.ts >> Graph View >> should load graph view
- Location: e2e/views.spec.ts:86:3
...
Call log:
  - navigating to "https://229hrqqh1vcj.share.zrok.io/graph", waiting until "load"
