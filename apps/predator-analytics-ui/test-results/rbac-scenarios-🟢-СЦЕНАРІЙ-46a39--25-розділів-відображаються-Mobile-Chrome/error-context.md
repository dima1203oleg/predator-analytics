...
- Name: rbac-scenarios.spec.ts >> 🟢 СЦЕНАРІЙ 1: Тестування ролі PROMO (Рівень 1) >> 1.1 Аудит Навігації: всі 25+ розділів відображаються
- Location: e2e/rbac-scenarios.spec.ts:59:3
...
- generic [ref=e7]:
  ...
  - generic [ref=e25]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e33]: "[СУПУТНИК] СЕНТИНЕЛЬ-47 ОНЛАЙН · 12.9 ГБ/с · ІНТЕ ЦЕПЦІЯ АКТИВНА"
