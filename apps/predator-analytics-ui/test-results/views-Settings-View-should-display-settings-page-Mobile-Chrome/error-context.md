...
- Name: views.spec.ts >> Settings View >> should display settings page
- Location: e2e/views.spec.ts:67:3
...
Call log:
  - navigating to "https://229hrqqh1vcj.share.zrok.io/settings", waiting until "load"
