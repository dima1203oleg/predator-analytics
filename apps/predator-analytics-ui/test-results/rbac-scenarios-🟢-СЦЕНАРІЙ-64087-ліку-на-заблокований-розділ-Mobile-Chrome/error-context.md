...
- Name: rbac-scenarios.spec.ts >> 🟢 СЦЕНАРІЙ 1: Тестування ролі PROMO (Рівень 1) >> 1.4 Аудит UI-Гвардів: UpgradePrompt при кліку на заблокований розділ
- Location: e2e/rbac-scenarios.spec.ts:104:3
...
- generic [ref=e7]:
  ...
  - generic [ref=e25]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e33]: "[СУПУТНИК] СЕНТИНЕЛЬ-47 ОНЛАЙН · 13.1 ГБ/с · ІНТЕ ЦЕПЦІЯ АКТИВНА"
