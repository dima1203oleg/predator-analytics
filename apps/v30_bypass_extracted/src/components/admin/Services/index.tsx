...
export const Services: React.FC = () => {
  const services = [
    { name: 'predator-api', port: 8000, version: 'v2.4.1', status: 'running' },
    { name: 'predator-ingest', port: 8001, version: 'v2.3.0', status: 'running' },
    { name: 'predator-nlp', port: 8002, version: 'v2.1.5', status: 'stopped' },
    { name: 'predator-crawler', port: 8003, version: 'v2.4.0', status: 'running' },
  ];
