  ...
  return (
    <div className="space-y-8 relative overflow-hidden p-8 rounded-[3rem] bg-[#050101] border-2 border-rose-950/20 ">
      ...
      <section className="relative z-10 p-10 bg-black/60  border-2 border-white/5 rounded-[3rem] shadow-4xl overflow-hidden mt-8 group">
          ...
          <div className="relative w-full max-w-4xl flex justify-between items-center z-10">
            ...
            >
              <div className="relative">
                ...
                <div className="w-24 h-24 rounded-3xl bg-amber-500/10 border-2 border-amber-500 flex flex-col items-center justify-center text-amber-500 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border-t-2 border-white/5 bg-black/60  p-8 gap-8">
          {[
