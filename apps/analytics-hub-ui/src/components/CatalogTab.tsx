      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-2">
          ...
          <div className="glass-panel-premium border-slate-800 rounded-2xl p-2 space-y-4" id="filters-container">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="input-premium pl-9 pr-3 py-2 text-xs text-slate-300 focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder:text-slate-600"
              />
            </div>
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          {filteredSolutions.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2" id="solutions-grid">
                  ...
                  >
                    ...
                    <div className="space-y-2 pt-2 border-t border-slate-800/50">
                      <div className="flex flex-wrap gap-1.5 text-xs">
                        ...
                        <span className={`border px-2 py-1 rounded-md ${getSecurityBadgeColor(sol.securityRating)}`}>
        ...
        {selectedSolution && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-2 bg-black/70 backdrop-blur-sm" id="solution-modal-container">
            ...
            >
              ...
              {/* Modal Body */}
              <div className="p-2 space-y-5 overflow-y-auto text-xs text-slate-300">
              ...
              <div className="px-2 py-1.5 bg-black/40 backdrop-blur-md border-t border-slate-800/80 flex justify-end">
                <button
                  ...
                  className="bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white px-2 py-1.5 rounded-2xl text-xs font-medium transition-colors"
                >
                  Закрити вікно
                </button>
              </div>
