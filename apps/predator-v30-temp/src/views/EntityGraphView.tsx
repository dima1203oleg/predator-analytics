...
interface GraphNode {
    id: string;
    type: 'PERSON' | 'ORGANIZATION' | 'ASSET' | 'TRANSACTION' | 'DEFAULT';
    label?: string;
    size?: number;
    x?: number;
    y?: number;
        ...
        const loadGraph = async () => {
            ...
            try {
                const mockNodes: GraphNode[] = [
                    { id: '1', type: 'PERSON', label: 'Дмитро Іванов', size: 40, x: 0, y: 0, flagged: true },
                    { id: '2', type: 'ORGANIZATION', label: 'Alpha Corp', size: 60, x: 100, y: 50 },
                    { id: '3', type: 'ORGANIZATION', label: 'Beta Holdings', size: 50, x: -100, y: 80 },
                    { id: '4', type: 'PERSON', label: 'Олена Петренко', size: 35, x: 50, y: -150 },
                    { id: '5', type: 'ASSET', label: 'Крипто-гаманець X', size: 30, x: -150, y: -100 },
                    { id: '6', type: 'TRANSACTION', label: 'TX-9921', size: 25, x: 200, y: -50 },
                ];

                const mockLinks: GraphLink[] = [
                    { source: '1', target: '2', type: 'OWNERSHIP', label: 'CEO & Founder' },
                    { source: '2', target: '3', type: 'OWNERSHIP', label: 'Subsidiary' },
                    { source: '1', target: '4', type: 'ASSOCIATION', label: 'Partner' },
                    { source: '3', target: '5', type: 'ASSOCIATION', label: 'Asset Holder' },
                    { source: '5', target: '6', type: 'TRANSACTION', label: 'Transfer' },
                ];
