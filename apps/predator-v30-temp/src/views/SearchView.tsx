...
const CompanyCard = ({ company, isPremium, isHackerMode }: { company: Company, isPremium: boolean, isHackerMode: boolean }) => {
                ...
                {isPremium ? (
                     <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="flex items-end lg:justify-end">
                            <button className="px-4 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 rounded-xl border border-emerald-500/20 text-[10px] font-black uppercase tracking-widest transition-all">
                                ЗВ'ЯЗКИ
                            </button>
                        </div>
                     </div>
        ...
        <div className={cn(
            ...
            <div className="grid grid-cols-1 gap-6 relative z-10">
                 ...
                 <div className="grid grid-cols-1 gap-6">
                    {results.map(company => (
                        <CompanyCard key={company.id} company={company} isPremium={isPremium} isHackerMode={isHackerMode} />
                    ))}
                 </div>
