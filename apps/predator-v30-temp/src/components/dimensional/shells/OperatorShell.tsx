...
export const OperatorShell: React.FC<OperatorShellProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center bg-slate-900/50 p-6 rounded-2xl border border-white/5 relative ">
        ...
        {[
          ...
          <TacticalCard key={idx} variant="holographic" className="p-4" title={metric.label}>
            <div className="mt-2 text-center">
              ...
              <div className="h-1.5 w-full bg-slate-800 rounded-full mt-3 ">
                <motion.div
                  initial={{ width: 0 }}
          ...
          <div className="space-y-3">
            {activeProcesses.length === 0 ? (
              ...
              activeProcesses.map((process, idx) => (
                <div key={idx} className="p-4 bg-slate-900/40 border border-cyan-500/20 rounded-2xl relative  group">
                  ...
                  <div className="h-1.5 bg-slate-950 rounded-full  relative z-10">
                    <motion.div
                      initial={{ width: 0 }}
