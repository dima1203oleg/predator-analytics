...
export const CyberGrid: React.FC<CyberGridProps> = ({ color, className }) => {
    return (
        <div className={`fixed inset-0 pointer-events-none z-[-1]  opacity-20 ${className || ''}`} style={color ? { color } : {}}>
            {/* Perspective Grid */}
            <div
