/**
 * SuperIntelligence Dashboard v25.0
 *
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 mt-1">Predator Analytics v25.0 — AI Command Center</p>
          </div>
          ...
          >
            ...
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
              ...
              <div className="mt-4 text-xs text-slate-500">
                Metrics available at: <code className="bg-slate-900 px-2 py-1 rounded">/api/v25/metrics</code>
              </div>
            </div>
          </motion.div>
        )}
