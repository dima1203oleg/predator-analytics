...
export const defaultSystemStats: StatItem[] = [
  { label: 'Активних Агентів', value: 12, change: 15, icon: <Brain size={18} />, color: 'cyan' },
  { label: 'Документів', value: '24.5K', change: 8, icon: <Database size={18} />, color: 'purple' },
  { label: 'CPU Навантаження', value: '67%', icon: <Server size={18} />, color: 'emerald' },
  { label: 'Запитів/сек', value: 1847, change: 23, icon: <Zap size={18} />, color: 'amber' },
];
