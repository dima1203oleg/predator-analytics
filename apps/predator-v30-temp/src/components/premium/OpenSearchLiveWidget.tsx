...
export const OpenSearchLiveWidget: React.FC<{
      ...
      >
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <div className="text-[8px] text-slate-500 uppercase tracking-widest">Документів</div>
          </div>
          {showChart && activityData.length > 0 && (
            <div className="w-20 h-10">
              <ReactECharts option={miniChartOption} style={{ height: '100%', width: '100%' }} theme="dark" />
            </div>
          )}
        </div>
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-6 relative z-10">
        <div className="p-4 bg-black/40 border border-white/5 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[9px] text-slate-500 font-black uppercase tracking-wider">Документи</span>
          </div>
        ...
        <div className="p-4 bg-black/40 border border-white/5 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[9px] text-slate-500 font-black uppercase tracking-wider">Пошуків/хв</span>
          </div>
        ...
        <div className="p-4 bg-black/40 border border-white/5 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[9px] text-slate-500 font-black uppercase tracking-wider">Латенсі</span>
          </div>
        ...
        <div className="p-4 bg-black/40 border border-white/5 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[9px] text-slate-500 font-black uppercase tracking-wider">Індексація/хв</span>
          </div>
      ...
      {showChart && activityData.length > 0 && (
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[9px] text-slate-500 font-black uppercase tracking-widest">Активність Пошуку</span>
            <span className="text-[8px] text-slate-600 font-mono">Останні 20 точок</span>
          </div>
      ...
      <a
        href="http://194.177.1.240:5601/app/dashboards"
        target="_blank"
