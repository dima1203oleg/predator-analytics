    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2">
           <Button variant="cyber" className="flex items-center gap-2 px-3 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg text-sm text-slate-300 transition-colors">
              ...
              {reports.map((report, idx) => (
                ...
                >
                  ...
                  <td className="p-4 text-right">
                    <Button variant="cyber" className="p-2 text-slate-300 hover:text-blue-400 hover:bg-blue-500/10 rounded transition-all" title="Завантажити">
                      <Download size={18} />
                    </Button>
                  </td>
                </motion.tr>
