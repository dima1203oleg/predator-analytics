...
describe('MaritimeView', () => {
    ...
    it('повинен рендерити базові елементи інтерфейсу', () => {
        ...
        expect(screen.getByPlaceholderText(/ПОШУК СУДНА, П АПО А, ПОРТУ/i)).toBeInTheDocument();
    ...
    it('повинен фільтрувати судна за пошуковим запитом', async () => {
        ...
        const searchInput = screen.getByPlaceholderText(/ПОШУК СУДНА, П АПО А, ПОРТУ/i);
