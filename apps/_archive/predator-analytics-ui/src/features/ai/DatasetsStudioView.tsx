      ...
      <div className="relative min-h-full bg-[#050202] p-8 lg:p-12 overflow-hidden selection:bg-cyan-500/30">
        ...
        <div className="relative z-10 max-w-[1800px] mx-auto space-y-10">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <h1 className="text-4xl font-black tracking-[0.2em] uppercase italic text-white/90">
                      СТУДІЯ <span className="text-cyan-500">ДАТАСЕТІВ</span>
                    </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {stats.map(s => (
              <HoloCard key={s.label} variant="holographic" className="bg-black/40 border-white/5 group hover:border-cyan-500/20 transition-all duration-500">
                 <div className="flex items-center gap-6">
                    <div className="p-4 bg-cyan-500/5 rounded-sm text-cyan-500 border border-cyan-500/10 group-hover:bg-cyan-500/10 transition-colors">
                      {s.icon}
                    </div>
            ...
            <div className="col-span-12 lg:col-span-3 space-y-4">
              <HoloCard variant="holographic" title="МОДУЛІ_СТУДІЇ" className="bg-black/40 border-white/5">
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <tab.icon size={14} className={cn(activeTab === tab.id ? "text-cyan-500" : "text-white/20")} />
                ...
                <div className="mt-8 pt-6 border-t border-white/5 space-y-4">
                   <Button variant="outline" onClick={triggerAutoGeneration} className="w-full h-12 rounded-sm border-dashed border-white/10 text-white/40 hover:text-cyan-500 hover:border-cyan-500/30 font-black tracking-widest text-[10px] uppercase italic">
            ...
            <div className="col-span-12 lg:col-span-9 space-y-8">
              <HoloCard variant="cyber" className="bg-black/40 border-white/5 relative overflow-hidden">
                 ...
                 <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-10 relative z-10">
                    ...
                    <div className="flex items-center gap-4">
                       <div className="relative group">
                          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-white/20 group-hover:text-cyan-500 transition-colors" />
                          <input 
                            type="text" 
                            placeholder="ПОШУК_ПО_ ЕПОЗИТО ІЮ..." 
                            className="bg-black/60 border border-white/10 rounded-sm pl-10 pr-4 py-2 text-[10px] text-white/80 outline-none focus:border-cyan-500/50 transition-all w-64 font-mono tracking-widest placeholder:text-white/10"
                          />
                       </div>
                       <Button size="icon" variant="ghost" className="rounded-sm h-10 w-10 text-white/20 hover:text-cyan-500 border border-white/5 hover:border-cyan-500/20 bg-white/[0.02]">
                          <Filter size={14} />
                       </Button>
                    </div>
                 </div>
                             ...
                             <tr key={ds.id} className="group hover:bg-white/[0.01] transition-all duration-300">
                                ...
                                <td className="py-6">
                                   <div className="flex items-center gap-3">
                                      ...
                                      <span className="text-[10px] font-black text-cyan-500 font-mono italic">{ds.quality}%</span>
                                   </div>
                                </td>
                                <td className="py-6">
                                   <div className="flex items-center gap-2">
                                      <div className={cn("w-1.5 h-1.5 rounded-full ", 
                                        ds.status === 'АКТИВНО' ? "bg-emerald-500" : ds.status === 'МОНІТОРИНГ' ? "bg-amber-500" : "bg-cyan-500"
                                      )} />
                                ...
                                <td className="py-6 text-right">
                                   <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
                                      <Button size="icon" variant="ghost" className="h-8 w-8 rounded-sm text-white/20 hover:text-cyan-500 border border-white/5 hover:border-cyan-500/20 bg-white/[0.02]">
                                      ...
                                      <Button size="icon" variant="ghost" className="h-8 w-8 rounded-sm text-white/20 hover:text-rose-400 border border-white/5 hover:border-cyan-400/20 bg-white/[0.02]">
                                         <Trash2 size={12} />
                                      </Button>
                                   </div>
                                </td>
              ...
              <motion.div 
                ...
                className="p-10 rounded-sm bg-gradient-to-r from-rose-950/40 via-black to-black border border-cyan-500/20 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group"
              >
                 ...
                 <div className="flex items-center gap-6 relative z-10">
                    <div className="w-16 h-16 rounded-sm bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-500 ">
                 ...
                 <Button onClick={triggerAutoGeneration} className="h-14 bg-cyan-600 hover:bg-cyan-500 text-white font-black text-[11px] uppercase tracking-[0.3em] rounded-sm px-12  hover: transition-all duration-500 border-none relative z-10">
