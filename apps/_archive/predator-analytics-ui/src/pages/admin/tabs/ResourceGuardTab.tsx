      ...
      <div className="flex justify-between items-end relative z-10">
        ...
        <div className="flex flex-col items-end">
          <span className={cn(
            ...
            isCritical ? "text-cyan-500 " : isHigh ? "text-amber-400" : "text-emerald-500/80"
          )}>
  ...
  if (statsLoading || infraLoading || failoverLoading) {
    return (
      <div className="flex flex-col items-center justify-center h-[700px] text-white/40 space-y-10 relative overflow-hidden">
        ...
        <div className="text-[14px] font-black font-mono uppercase tracking-[0.6em]  italic text-cyan-500/60">СИНХРОНІЗАЦІЯ_МЕТРИК_ЗАХИСТУ_V61...</div>
      </div>
    );
  }
        ...
        <div className="flex flex-col gap-3 border-l-4 border-cyan-500 pl-10 py-2">
          <div className="flex items-center gap-6">
            <h2 className="text-4xl font-black text-white uppercase tracking-tighter italic glint-elite">
              VRAM GUARD <span className="text-cyan-500">& РЕСУРСНИЙ ДИСПЕТЧЕР</span>
            </h2>
          ...
          <div className="flex items-center gap-8 text-[11px] font-black font-mono text-white/30 tracking-[0.2em] uppercase italic">
            ...
            <div className="flex items-center gap-3">
               <ZapIcon size={14} className="text-cyan-500/60" />
      ...
      <div className="grid grid-cols-12 gap-12 relative z-10">
            ...
            <div className="space-y-6">
              ...
              <div className="p-8 glass-wraith border-2 border-white/5 rounded-[2.5rem] space-y-8 relative overflow-hidden shadow-4xl group">
                 ...
                 <div className="flex justify-between items-center relative z-10">
                    ...
                    <div className="px-4 py-1.5 bg-cyan-500/10 border-2 border-cyan-500/40 rounded-xl text-[9px] font-black text-cyan-500 uppercase tracking-widest italic  shadow-cyan-500/20">АКТИВНИЙ_ЗАХИСТ</div>
                 </div>
                 ...
                 <div className="space-y-6 relative z-10">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5 group-hover:border-cyan-500/20 transition-all duration-700">
                       <div className="flex items-center gap-4">
                 ...
                 {isCloudOverride && (
                    <motion.div 
                      ...
                      className="p-6 bg-cyan-600 border-2 border-cyan-400 rounded-3xl flex items-start gap-6 mt-4 shadow-4xl relative z-10"
                    >
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col gap-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Sovereign Node */}
            <div className="glass-wraith p-10 rounded-[3rem] border-2 border-white/5 relative overflow-hidden group hover:border-cyan-500/40 transition-all duration-1000 shadow-4xl">
               <div className="absolute inset-0 bg-cyber-grid opacity-[0.02] pointer-events-none" />
               <div className="flex items-center justify-between mb-8 relative z-10">
                  <div className="flex flex-col">
                     <span className="text-[10px] font-black font-mono text-cyan-500/60 uppercase tracking-[0.4em] italic mb-2">СУВЕРЕННИЙ_ОФЛОАД</span>
                     <span className="text-2xl font-black text-white italic tracking-tighter uppercase glint-elite">SOVEREIGN_NODE_NVIDIA</span>
                  </div>
                  <div className="p-4 bg-cyan-500/10 rounded-2xl border-2 border-cyan-500/20 group-hover:bg-cyan-500/20 transition-all duration-700">
                     <Server size={24} className="text-cyan-500" />
                  </div>
               </div>
               
               <div className="grid grid-cols-2 gap-6 mb-10 relative z-10">
                  <div className="p-5 bg-white/5 border border-white/5 rounded-2xl flex flex-col gap-1 group-hover:border-cyan-500/20 transition-all duration-700 shadow-inner">
                     <span className="text-[8px] text-white/20 uppercase font-black tracking-widest italic">ЗВ'ЯЗОК_LAN</span>
                     <span className="text-[12px] font-black text-cyan-500 uppercase tracking-tighter font-mono">194.177.1.240</span>
                  </div>
                  <div className="p-5 bg-white/5 border border-white/5 rounded-2xl flex flex-col gap-1 group-hover:border-cyan-500/20 transition-all duration-700 shadow-inner">
               ...
               <Button variant="cyber" 
                 ...
                 className={cn(
                   ...
                   llmTriStateMode === 'SOVEREIGN'
                     ? "bg-cyan-500/10 border-cyan-500/30 text-rose-400 cursor-default"
                     : "bg-cyan-600 text-white border-cyan-400  hover:bg-cyan-500 hover:scale-[1.02]"
                 )}
               >
          ...
          <div className="space-y-8 relative z-10">
             <div className="flex items-center gap-6 px-4">
                <div className="w-2.5 h-2.5 bg-cyan-500 rotate-45 " />
             ...
             <div className="glass-wraith border-2 border-white/5 rounded-[3.5rem] p-4 h-[450px] overflow-y-auto custom-scrollbar shadow-4xl">
                {(infra?.nodes.flatMap(node => node.pods || []) || [
                  ...
                  <motion.div 
                    ...
                    className="flex items-center justify-between p-6 bg-white/[0.02] border-2 border-white/5 rounded-[2rem] group hover:border-cyan-500/40 transition-all duration-700 mb-4 shadow-2xl relative overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-cyber-grid opacity-[0.01] pointer-events-none" />
                    <div className="flex items-center gap-6 relative z-10">
                      <div className="w-12 h-12 rounded-2xl bg-black/60 border-2 border-white/5 flex items-center justify-center font-black text-[10px] text-cyan-500 uppercase italic shadow-inner group-hover:border-cyan-500/20 transition-all">
                        {proc.type || 'SVC'}
                      </div>
                      <div className="flex flex-col gap-1">
                        <span className="text-[14px] font-black text-white italic tracking-tighter uppercase glint-elite group-hover:text-cyan-500 transition-colors">{proc.name}</span>
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2">
                             <div className={cn("w-1.5 h-1.5 rounded-full ", proc.status === 'Running' ? "bg-emerald-500 shadow-emerald-500/40" : "bg-cyan-500")} />
                    ...
                    <div className="flex items-center gap-10 relative z-10">
                       <div className="flex flex-col items-end gap-1">
                          ...
                          <div className="flex items-center gap-3">
                             {failover?.activeNode === 'local-k3s' ? <Monitor size={14} className="text-cyan-500" /> : <Globe size={14} className="text-sky-500" />}
                             <span className={cn("text-[11px] font-black italic tracking-widest uppercase", failover?.activeNode === 'local-k3s' ? "text-cyan-500" : "text-sky-400")}>
                               {failover?.activeNode?.replace('local-k3s', 'LOCAL_SOVEREIGN').replace('nvidia-server', 'NVIDIA_CLOUD') || 'INTERNAL_K3S'}
                             </span>
                          </div>
                       </div>
                       <Button variant="cyber" className="p-4 bg-white/5 border-2 border-white/5 rounded-2xl hover:bg-cyan-500/10 hover:border-cyan-500/40 transition-all duration-700 group/btn shadow-inner">
                          <ArrowRightLeft size={16} className="text-white/20 group-hover/btn:text-cyan-500 group-hover/btn:rotate-180 transition-all duration-1000" />
                       </Button>
                    </div>
                  </motion.div>
                ))}
