...
export const ExplainabilityPanel: React.FC<ExplainabilityPanelProps> = ({
  ...
  const mockExplanation: Explanation = explanation || {
    ...
    graph_paths: [
      {
        nodes: [
          { id: 'c1', type: 'company', name: 'ТОВ "РОМАШКА"' },
      ...
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">ПОЯСНЕННЯ РІШЕННЯ</h2>
        ...
        <div className="mt-4 p-4 bg-slate-800/50 rounded-xl">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <span className="text-xs text-slate-500 uppercase">Рішення</span>
