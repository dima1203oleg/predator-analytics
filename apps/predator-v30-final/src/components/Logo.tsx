...
export const Logo: React.FC<LogoProps> = ({ className = '', size = 'md', animated = true }) => {
    ...
    return (
        <div className={`relative ${className}`}>
            <div className={`${s.box} bg-slate-900 rounded-lg border-2 border-primary-500 flex items-center justify-center text-primary-400 font-bold ${s.text} shadow-[0_0_20px_rgba(6,182,212,0.4)] relative  group icon-3d-blue`}>
