...
const Modal: React.FC<ModalProps> = ({ 
  ...
  return (
    ...
    >
      <div 
        className={`bg-slate-900 border border-slate-700 rounded-lg shadow-2xl w-full ${sizeClasses[size]} flex flex-col  animate-in zoom-in-95 duration-200 ${className} max-h-full`}
