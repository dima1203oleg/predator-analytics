...
class SpendingHarvester:
    ...
    async def harvest_historical(self, start_date: date, end_date: date) -> None:
        """Оркестрація історичного завантаження за допомогою мікробатчів."""
        current_date = start_date
        total_days = (end_date - start_date).days + 1
        
        logger.info(f"SpendingHarvester: Початок історичного завантаження ({total_days} днів).")
        ...
        while current_date <= end_date:
            ...
            if date_str in processed_dates:
                ...
                # TODO: Відправити transactions у Kafka Producer тут
                
                # Зберігаємо стан (commit)
