...
Цей модуль відповідає за інтеграцію з ЄДР (Єдиний державний реєстр) 
через стороннє API (наприклад, YouControl або OpenDataBot) або з відкритих дампів.
Фокус на розпізнаванні складної ієрархії власності та зв'язків.
"""
import asyncio
import logging
