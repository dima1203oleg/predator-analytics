...
class AnomalyDetectionService:
    ...
    def _load_known_patterns(self) -> dict[PatternType, dict]:
    ...
    def _check_circular_transactions(self, transactions: list[dict] | None) -> bool:
    ...
    def _find_shared_attributes(self, entities: list[dict]) -> list[dict]:
