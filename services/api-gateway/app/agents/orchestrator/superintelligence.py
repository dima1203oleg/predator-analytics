...
class CriticAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            result = await self.llm.query(critique_prompt)
            return {
                "agent": self.name,
...
class SelfHealingController:
    ...
    def __init__(self):
        ...
        self.recovery_progress: Optional[float] = None
    ...
    def _determine_strategy(self, component: str) -> RecoveryStrategy:
        ...
        elif component in ["database", "redis"]:
...
class SuperIntelligenceOrchestrator:
    ...
    async def _handle_deep(
        ...
        if humint_result.get("iocs"):
            ...
            cybint_result = await self.agents[AgentType.CYBINT].process({
    ...
    async def _handle_auto(
        ...
        elif any(word in query_lower for word in ["analyze", "deep", "investigate", "threat"]):
...
_orchestrator_instance: Optional[SuperIntelligenceOrchestrator] = None
