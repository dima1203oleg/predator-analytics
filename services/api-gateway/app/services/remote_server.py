...
class RemoteServerManager:
    ...
    def parse_ngrok_message(self, text: str) -> Optional[ServerConnection]:
        """
...
• Host: `{conn.host}`
• Port: `{conn.port}`
• HTTP: {conn.http_url if conn.http_url else 'N/A'}
...
"""
    ...
    async def check_connection(self) -> Tuple[bool, str]:
        ...
        if result.success:
            ...
            self.current_connection.last_seen = datetime.now(timezone.utc)
