...
import logging
from . import CouncilMember, CouncilResponse, PeerReview, ConsensusResult
from .models.openai_member import GPT4CouncilMember, GPT3_5CouncilMember
...
class LLMCouncilOrchestrator:
    ...
    async def deliberate(
        ...
        try:
            ...
            logger.error(f"System context injection failed: {e}")
