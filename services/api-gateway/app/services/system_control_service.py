import logging
from libs.core.redis import get_redis
...
class SystemControlService:
    ...
    def __new__(cls):
        if cls._instance is None:
            cls._instance = super(SystemControlService, cls).__new__(cls)
    ...
    async def toggle_lockdown(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to persist lockdown state to Redis: {e}")
    ...
    async def is_lockdown(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to read lockdown state from Redis: {e}")
