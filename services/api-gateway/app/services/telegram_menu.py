...
"""
    ...
    @staticmethod
    def format_nvidia_welcome(host: str = None, is_connected: bool = False) -> str:
...
"""
    ...
    @staticmethod
    def format_task_result(description: str, output: str, error: Optional[str] = None, 
...
"""
    ...
    @staticmethod
    def format_server_status(local_status: dict, nvidia_status: dict = None) -> str:
...
"""
    ...
    @staticmethod
    def format_connection_info(ssh_host: str, ssh_port: int, http_url: str = None) -> str:
