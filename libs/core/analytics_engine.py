...
from libs.core.models.analytics import BehavioralProfile, InstitutionalBias, InfluenceGraph, PredictiveAlert
...
class AnalyticalEngine:
    ...
    async def get_entity_profile(self, entity_id: str) -> Dict[str, Any]:
        ...
        connections = await self.influence.discover_connections(UUID(entity_id) if len(entity_id) == 36 else UUID(int=0))
        influence_signals = [
