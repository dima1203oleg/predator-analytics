...
class SimpleNvidiaTester:
    ...
    def test_basic_connectivity(self):
        ...
        # Backend
        status, content = self.check_url(f"{self.api_url}/health")
    ...
    def test_websocket_endpoint(self):
        ...
        try:
            ...
            status, content = self.check_url(f"ws://{self.nvidia_ip}:8090/api/v25/ws/omniscience")
    ...
    def test_additional_services(self):
        ...
        for service_url, name in services:
            status, content = self.check_url(service_url.format(self.nvidia_ip))
            if status == 200:
    ...
    def print_results(self):
        ...
        if len(self.errors) == 0:
            ...
            print("🌐 Доступ: http://{}:8092".format(self.nvidia_ip))
            print("🔮 Omniscience: http://{}:8092/omniscience".format(self.nvidia_ip))
        else:
