# 🚀 Predator Analytics v25 - Звіт Покращень (2026-01-11)
...
# Статус місії
GET /api/v25/missions/{mission_id}

# Список всіх місій
GET /api/v25/missions?status=in_progress

# Статистика агентів
GET /api/v25/missions/agents/stats

# Тестові місії
POST /api/v25/missions/test/threat-analysis
POST /api/v25/missions/test/data-processing
POST /api/v25/missions/test/system-health
```
