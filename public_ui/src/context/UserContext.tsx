...
export const UserProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (token) {
        // Here we would decode token. For now, assume session valid if token exists.
        // We do NOT restore user automatically in this demo without real backend
        // because we want to show the Role Selection on first load usually.
        // OR: we can restore 'Demo Admin' if token is 'admin-token'.
