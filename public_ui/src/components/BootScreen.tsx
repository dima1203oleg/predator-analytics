...
const BootScreen: React.FC<BootScreenProps> = ({ onComplete }) => {
  ...
  const bootSequence = [
    ...
    { msg: "KERNEL: Завантаження ядра PredatorOS v25.0 (Singularity Kernel)", delay: 900 },
      ...
      <div className="w-full max-w-lg space-y-8 p-8 relative z-30 animate-in fade-in duration-1000">
        ...
        <div className="flex flex-col items-center justify-center gap-4 mb-10">
          <div className="relative group">
              ...
              <div className="absolute -bottom-2 -right-2 bg-black px-1 text-[10px] text-primary-500 border border-primary-500">v25.0</div>
          </div>
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-[0.3em] text-white font-display text-glow-quantum animate-pulse">PREDATOR</h1>
            <p className="text-xs text-slate-500 tracking-widest mt-1 uppercase">Автономна Система Інтелекту</p>
          </div>
        </div>
