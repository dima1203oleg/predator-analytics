...
export const Dashboards: React.FC = () => {
  ...
  const metrics = [
    { title: "Загальний обсяг даних", value: "128.4 TB", change: "+2.1%", icon: Globe, color: "text-blue-400", bg: "bg-blue-500/10" },
    { title: "Активні монітори", value: "1,240", change: "+12", icon: Activity, color: "text-emerald-400", bg: "bg-emerald-500/10" },
    { title: "Виявлено аномалій", value: "24", change: "-5%", icon: Zap, color: "text-amber-400", bg: "bg-amber-500/10" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-6">
         <div>
           <h1 className="text-2xl font-bold text-white">Операційна Аналітика</h1>
           <p className="text-slate-400 text-sm">Моніторинг ключових показників у реальному часі.</p>
         </div>
         <SensitiveDataToggle />
      </div>
        ...
        {metrics.map((metric, i) => (
          ...
          >
             ...
             <div className="text-3xl font-bold text-white mb-1">
               {isEnabled || metric.title === "Загальний обсяг даних" ? metric.value : '****'}
             </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
         <div className="bg-slate-900/50 border border-slate-700/50 p-6 rounded-xl h-80 flex flex-col">
            <h3 className="font-bold text-white mb-6 flex items-center gap-2">
               <BarChart3 size={18} className="text-blue-400" /> Динаміка активності
            </h3>
         ...
         <div className="bg-slate-900/50 border border-slate-700/50 p-6 rounded-xl h-80 flex flex-col">
            <h3 className="font-bold text-white mb-6 flex items-center gap-2">
               <PieChart size={18} className="text-purple-400" /> Розподіл ресурсів
            </h3>
