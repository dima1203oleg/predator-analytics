...
export const HoloContainer: React.FC<HoloContainerProps> = ({
    ...
    return (
        <div className={`relative ${className} group overflow-hidden border rounded-xl bg-[#0a0f1c]/70 backdrop-blur-md transition-all duration-500 shadow-2xl shadow-black/80 ${s.border} ${s.borderHover}`}>
