  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center py-8 border-b border-white/5">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-white mb-4">Ранкова Газета</h1>
      ...
      <div className="grid gap-8">
        {articles.map((article) => (
          <motion.article
            ...
            className={`
              relative bg-slate-900/30 border border-slate-800 rounded-2xl overflow-hidden group
