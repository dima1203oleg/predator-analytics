...
const MonitoringView: React.FC = () => {
    ...
    const renderNeuralTrace = () => (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="lg:col-span-1 space-y-6">
                <TacticalCard variant="holographic" title="РЕЄСТР НЕЙРОННИХ КОМАНД" className="min-h-[600px] border-white/5 bg-slate-950/40">
    ...
    const renderSimulationView = () => (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <TacticalCard variant="holographic" title="ЦИФРОВИЙ ДВІЙНИК: БОЙОВІ ТЕСТИ" className="panel-3d glass-ultra rounded-[32px] shadow-2xl overflow-hidden min-h-[500px]">
                <div className="p-8 space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <h4 className="text-sm font-black text-white uppercase tracking-widest">Стрес-Тест</h4>
                            </div>
                            <p className="text-[10px] text-slate-500 font-medium leading-relaxed">Симуляція екстремального навантаження на API та черги для перевірки авто-масштабування.</p>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <h4 className="text-sm font-black text-white uppercase tracking-widest">Отруєння Даних</h4>
                            </div>
                            <p className="text-[10px] text-slate-500 font-medium leading-relaxed">Атака на цілісність даних: ін'єкція аномальних записів у тренувальний набір.</p>
                    ...
                    <div className="p-8 bg-blue-500/5 rounded-[32px] border border-blue-500/10">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h4 className="text-xs font-black text-white uppercase tracking-widest">Статистика Цифрового Двійника</h4>
                        </div>
                        <div className="grid grid-cols-2 gap-8">
                            <div className="space-y-1">
                                <div className="text-[10px] text-slate-500 uppercase font-black">Індекс Стійкості</div>
                                <div className="text-2xl font-black text-emerald-400 font-mono">0.942</div>
                            </div>
                            <div className="space-y-1">
                                <div className="text-[10px] text-slate-500 uppercase font-black">Середній Час Відновлення</div>
            ...
            <TacticalCard variant="holographic" title="КЕРУВАННЯ ОБСЛУГОВУВАННЯМ ШІ" className="panel-3d glass-ultra rounded-[32px] shadow-2xl overflow-hidden min-h-[500px]">
                <div className="p-8 space-y-8">
                    <div className="flex flex-col gap-4">
                        {[
                            { id: 'v_db', icon: <Database />, title: 'Vacuum Analytical Storage', desc: 'Оптимізація Postgres Gold Layer. Покращує швидкість складних SQL запитів.', action: 'vacuum_db' },
                            { id: 'v_idx', icon: <Network />, title: 'Reclaim Vector Space', desc: 'Очищення та дефрагментація векторних індексів у Qdrant та OpenSearch.', action: 'reclaim_vectors' }
                        ].map((m) => (
                    ...
                    <div className="relative mt-4">
                        <div className="flex justify-between items-center mb-3">
                            <span className="text-[10px] text-slate-500 font-black uppercase tracking-widest">Автономна Оптимізація</span>
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700 pb-24 w-full max-w-[1700px] mx-auto relative z-10 min-h-screen">
            ...
            >
                {(['METRICS', 'LOGS', 'SAGA', 'JOBS', 'NEURAL', 'LLM', 'STORAGE', 'ANALYTICS', 'SIMULATION'] as MonTab[]).map((tab) => {
                    ...
                    if (!canSeeExtra && (tab !== 'METRICS' && tab !== 'SIMULATION')) return null;
