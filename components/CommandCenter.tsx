  ...
  const [logs, setLogs] = useState<CommandLog[]>([
    {
      id: 'init',
      command: 'system info',
      output: <span className="text-slate-400">Predator Analytics v18.6 [Режим Правди]<br />Kernel: Linux 5.15.0-generic (x86_64)<br />Node: k3s-master-01 [ОНЛАЙН]<br />Locale: uk_UA.UTF-8</span>,
