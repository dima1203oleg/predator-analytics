...
Цей документ пояснює, як підготувати локальне середовище та DevContainer для роботи з Predator v25.0.
...
1. Створіть семантичний тег: `git tag -a v25.0.1 -m "Release v25.0.1"`.
2. Відправте тег у репозиторій: `git push origin v25.0.1`.
