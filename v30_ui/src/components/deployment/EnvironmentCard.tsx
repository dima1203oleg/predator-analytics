...
export const EnvironmentCard: React.FC<EnvironmentCardProps> = ({ env, onSync, onTest }) => {
    ...
    return (
        <div className={`bg-slate-900 border rounded-lg  flex flex-col h-full panel-3d transition-all ${getBorderColor()}`}>
            {/* Header */}
            ...
            {/* Logs Snippet */}
            <div className="h-24 bg-black border-t border-slate-800 p-2 font-mono text-[9px]  relative">
