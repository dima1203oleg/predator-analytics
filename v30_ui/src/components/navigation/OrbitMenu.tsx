...
import { Fingerprint, Cpu, Dna, Search, Network, Trophy } from 'lucide-react';
...
const OrbitMenu: React.FC = () => {
  ...
  const menuItems = [
    { icon: <Cpu size={20} />, label: 'Omni', color: 'text-blue-400', path: '/overview' },
    { icon: <Network size={20} />, label: 'Radar', color: 'text-emerald-400', path: '/analytics' },
    { icon: <Search size={20} />, label: 'Search', color: 'text-cyan-400', path: '/search-v2' },
    { icon: <Trophy size={20} />, label: 'NAS', color: 'text-amber-400', path: '/llm/nas' },
    { icon: <Dna size={20} />, label: 'Evolution', color: 'text-rose-400', path: '/evolution' },
  ];
