...
export const Toast: React.FC<ToastProps> = ({ toast, onClose }) => {
    ...
    return (
        <div className={`relative w-80 mb-3 rounded-lg border backdrop-blur-md shadow-2xl  panel-3d transition-all duration-300 ${config.bg} ${config.border} ${isExiting ? 'opacity-0 translate-x-full' : 'opacity-100 translate-x-0 animate-in slide-in-from-right-4'}`}>
