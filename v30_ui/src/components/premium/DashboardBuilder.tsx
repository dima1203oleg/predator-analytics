...
const AVAILABLE_WIDGETS: Widget[] = [
  ...
  { id: 'w_risks', type: 'chart', title: 'Аналіз Ризиків', size: 'medium', icon: TrendingUp, color: 'from-rose-600 to-red-700' },
    ...
    <div className="space-y-8 min-h-screen">
      ...
      {activeWidgets.length === 0 && (
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-white mb-2">Робочий простір порожній</h3>
