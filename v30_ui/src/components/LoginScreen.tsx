...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
    ...
    const handleDemoLogin = (role: UserRole) => {
        ...
        setUser({
            ...
            name: role === UserRole.ADMIN ? 'Адміністратор Системи' : role === UserRole.CLIENT_PREMIUM ? 'Преміум Аналітик' : 'Базовий Користувач',
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <motion.button
                        ...
                        className="bg-slate-900/50 border border-amber-500/30 p-8 rounded-2xl text-left transition-all hover:border-amber-500/50 group relative "
                    >
                        <div className="absolute top-0 right-0 p-3 bg-amber-500/10 rounded-bl-xl border-b border-l border-amber-500/20">
                            <span className="text-[10px] font-bold text-amber-500 uppercase">Рекомендовано</span>
                        </div>
