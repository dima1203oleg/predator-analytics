...
rsync -avz --delete -e "ssh -F /Users/Shared/Predator_60/.ssh.config.optimized -o StrictHostKeyChecking=no" apps/predator-analytics-ui/dist/ predator-server:/tmp/predator-frontend-dist/
