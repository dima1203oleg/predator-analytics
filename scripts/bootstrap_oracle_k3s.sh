...
# Скрипт для ініціалізації k3s та ArgoCD на Oracle-сервері
# Запускати на Oracle-сервері з sudo
...
echo "Збереження kubeconfig у файл kubeconfig-oracle.yaml..."
cp /etc/rancher/k3s/k3s.yaml kubeconfig-oracle.yaml
