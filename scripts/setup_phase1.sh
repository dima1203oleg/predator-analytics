...
DIRS=(
    ...
    "schemas"
    "services/mcp-router/providers"
    "services/mcp-router/tests"
    "services/rtb-engine/rules"
    "services/rtb-engine/audit"
    "services/rtb-engine/tests"
    "services/sio-controller/tests"
    "services/automl-controller/tests"
    "services/training-controller/tests"
    "services/validation-controller/tests"
