...
FILES=(
    ...
    "services/api-gateway/app/api/v25_routes.py"
...
echo "  2. Моніторте передбачення: curl http://localhost:8000/api/v1/v25/autonomous/predictions"
echo "  3. Переглядайте рішення: curl http://localhost:8000/api/v1/v25/autonomous/decisions"
...
echo "  - Health Check: http://localhost:8000/api/v1/v25/autonomous/health"
echo ""
