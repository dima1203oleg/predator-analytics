...
### Звіт про безпеку доступу / RBAC & ABAC

> [!WARNING]
> Перевірка Zero-Trust правил, ABAC та динамічного маскування фінансових транзакцій.

- **Маскування даних (Data Redaction):** `ACTIVE`
- **Криптографічна токенізація UBO:** `ENABLED`
- **Контроль витоку RAW даних:** `VERIFIED`
- **Запобігання внутрішнім загрозам:** `STRICT`
- **Тимчасові політики доступу (Temporal):** `ACTIVE`
