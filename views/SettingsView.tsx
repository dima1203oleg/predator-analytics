        ...
        <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {providers.map(provider => (
                    <TacticalCard key={provider.id} title={`${provider.name} Конфігурація`} className="panel-3d">
            ...
            <div className="flex flex-wrap gap-2 border-b border-slate-800 pb-1 mb-6 overflow-x-auto scrollbar-hide">
                {[
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-t-lg text-xs font-bold flex items-center gap-2 transition-all whitespace-nowrap btn-3d ${activeTab === tab.id
