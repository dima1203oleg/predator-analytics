    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20 w-full max-w-[1600px] mx-auto">
            ...
            <ViewHeader
                ...
                breadcrumbs={['ДАНІ', 'СХОВИЩЕ']}
                stats={[
                    { label: 'Загальний Обсяг', value: '18.4 TB', icon: <HardDrive size={14} className="icon-3d-amber" />, color: 'primary' },
                    { label: "Здоров'я DB", value: 'ЗДОРОВИЙ', icon: <Activity size={14} className="icon-3d-green" />, color: 'success' },
