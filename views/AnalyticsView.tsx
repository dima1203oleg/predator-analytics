...
import { 
  ...
  Siren, Microscope, ShieldAlert, Crosshair, Database, RefreshCw, Calendar
} from 'lucide-react';
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-24 w-full max-w-[1600px] mx-auto min-h-screen relative">
       ...
       <ViewHeader 
            ...
            stats={[
                ...
                { label: 'Neural Engine', value: 'GEMINI 3', icon: <BrainCircuit size={14}/>, color: 'purple' },
            ...
            {(Object.keys(SECTOR_CONFIG) as SectorType[]).map(sector => {
                ...
                return (
                    <button 
                        ...
                        className={`flex-1 min-w-[120px] py-4 text-xs font-bold border-b-2 transition-all flex flex-col items-center justify-center gap-2 relative overflow-hidden group ${
                            isActive 
        ...
        <div className="relative z-10 -mt-6 mx-2 sm:mx-6">
            <div className="bg-slate-900/95 backdrop-blur-xl border border-slate-700 p-2 rounded-xl shadow-2xl flex flex-col sm:flex-row gap-2 items-center panel-3d ring-1 ring-white/5">
                ...
                <button 
                    ...
                    className={`w-full sm:w-auto px-8 py-3 rounded-lg font-bold text-sm uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(0,0,0,0.3)] btn-3d flex items-center justify-center gap-2 ${
                        isScanning 
                        ...
                        <div className="w-full h-full relative">
                            ...
                            {MOCK_NODES.map((node, i) => (
                                ...
                                >
                                    ...
                                    <div className={`mt-2 px-2 py-1 rounded text-[10px] font-bold backdrop-blur-md border transition-all ${
                                        node.type === 'MAIN' ? 'bg-blue-900/80 border-blue-500 text-white' : 
                            ...
                            <div className="relative pl-8 space-y-8">
                                ...
                                {scanResult.timeline.map((event: any, i: number) => (
                                    <div key={i} className="relative flex items-center gap-6 group animate-in slide-in-from-right-4 duration-500" style={{ animationDelay: `${i*100}ms` }}>
                                        ...
                                        {/* Node Dot */}
                                        <div className={`w-6 h-6 rounded-full border-4 z-10 transition-colors flex items-center justify-center shrink-0 ${
                                            event.risk > 80 ? 'border-red-900 bg-red-500 shadow-[0_0_15px_red]' : 
                                        ...
                                        <div className="flex-1 bg-slate-900/50 p-4 rounded border border-slate-800 group-hover:border-slate-600 transition-colors hover:bg-slate-900 cursor-pointer backdrop-blur-sm">
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded border ${
                                                    event.risk > 80 ? 'text-red-400 border-red-900/50 bg-red-900/20' : 
