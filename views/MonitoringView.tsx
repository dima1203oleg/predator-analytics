    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-24 w-full max-w-[1600px] mx-auto">
            ...
            <ViewHeader
                ...
                stats={[
                    { label: 'Prometheus', value: 'ОНЛАЙН', icon: <Eye size={14} />, color: 'success' },
                    { label: 'Saga Tx', value: 'АКТИВНО', icon: <Layers size={14} />, color: 'primary' },
                    { label: 'Алерти', value: String(mockAlerts.length), icon: <Activity size={14} />, color: mockAlerts.some(a => a.severity === 'critical') ? 'danger' : 'warning' },
                ]}
            />
