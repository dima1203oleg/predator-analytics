         ...
         <div className="bg-slate-900 border border-slate-700 rounded-xl p-6">
            ...
            <div className="space-y-4">
               <div>
                  ...
                  <div className="h-2 w-full bg-slate-800 rounded-full "><div className="h-full bg-blue-500 w-[32%]" /></div>
               </div>
               <div>
                  <div className="flex justify-between text-xs text-slate-400 mb-1"><span>RAM (64 GB)</span> <span>45%</span></div>
                  <div className="h-2 w-full bg-slate-800 rounded-full "><div className="h-full bg-purple-500 w-[45%]" /></div>
               </div>
               <div>
                  <div className="flex justify-between text-xs text-slate-400 mb-1"><span>NVMe Storage (2 TB)</span> <span>78%</span></div>
                  <div className="h-2 w-full bg-slate-800 rounded-full "><div className="h-full bg-amber-500 w-[78%]" /></div>
               </div>
            </div>
         </div>
