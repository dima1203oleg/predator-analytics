...
const DataFlowTopology = () => (
    <div className="relative h-[200px] w-full bg-slate-950 border border-slate-800 rounded-lg overflow-hidden mb-6 group">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none">
            ...
            {/* Paths */}
            <path d="M 50 50 C 150 50, 150 100, 250 100" stroke="#1e293b" strokeWidth="2" fill="none" />
            <path d="M 50 150 C 150 150, 150 100, 250 100" stroke="#1e293b" strokeWidth="2" fill="none" />
            <path d="M 250 100 L 450 100" stroke="#1e293b" strokeWidth="2" fill="none" />
            <path d="M 450 100 C 550 100, 550 50, 650 50" stroke="#1e293b" strokeWidth="2" fill="none" />
            <path d="M 450 100 C 550 100, 550 150, 650 150" stroke="#1e293b" strokeWidth="2" fill="none" />

            {/* Moving Particles */}
            <circle r="3" fill="#3b82f6" filter="url(#glow)">
                <animateMotion dur="2s" repeatCount="indefinite" path="M 50 50 C 150 50, 150 100, 250 100" />
            </circle>
            <circle r="3" fill="#eab308" filter="url(#glow)">
                <animateMotion dur="3s" repeatCount="indefinite" path="M 50 150 C 150 150, 150 100, 250 100" />
            </circle>
            <circle r="4" fill="#a855f7" filter="url(#glow)">
                <animateMotion dur="1.5s" repeatCount="indefinite" path="M 250 100 L 450 100" />
            </circle>
            <circle r="3" fill="#22c55e" filter="url(#glow)">
                <animateMotion dur="2.5s" repeatCount="indefinite" path="M 450 100 C 550 100, 550 50, 650 50" />
            </circle>
        </svg>
        ...
        <div className="absolute inset-0 flex justify-between items-center px-12">
            <div className="flex flex-col gap-16">
                <div className="flex items-center gap-2">
                    <div className="p-2 bg-blue-900/20 border border-blue-500/50 rounded-lg text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                        <Globe size={20} />
                    </div>
                    <div className="text-[10px] text-slate-400 font-bold">WEB</div>
                </div>
                <div className="flex items-center gap-2">
                    <div className="p-2 bg-yellow-900/20 border border-yellow-500/50 rounded-lg text-yellow-400 shadow-[0_0_15px_rgba(234,179,8,0.3)]">
                        <FileText size={20} />
                    </div>
                    <div className="text-[10px] text-slate-400 font-bold">FILES</div>
                </div>
            </div>

            <div className="flex flex-col items-center gap-2">
                <div className="w-16 h-16 bg-slate-900 border-2 border-purple-500 rounded-full flex items-center justify-center relative shadow-[0_0_30px_rgba(168,85,247,0.4)]">
                ...
                <div className="text-[10px] text-purple-400 font-bold bg-slate-900 px-2 py-0.5 rounded border border-purple-500/30">ETL CORE</div>
            </div>

            <div className="flex flex-col gap-16">
                <div className="flex items-center gap-2 flex-row-reverse">
                    <div className="p-2 bg-green-900/20 border border-green-500/50 rounded-lg text-green-400 shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                        <Database size={20} />
                    </div>
                    <div className="text-[10px] text-slate-400 font-bold">SQL</div>
                </div>
                <div className="flex items-center gap-2 flex-row-reverse">
                    <div className="p-2 bg-indigo-900/20 border border-indigo-500/50 rounded-lg text-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                        <Layers size={20} />
                    </div>
                    <div className="text-[10px] text-slate-400 font-bold">VEC</div>
                </div>
            </div>
        </div>
    </div>
...
const SecretRow: React.FC<SecretRowProps> = ({ secret, onTest, onSave }) => {
    ...
    return (
        <div className="bg-slate-900/50 border border-slate-800 rounded p-4 flex flex-col md:flex-row items-start md:items-center gap-4 transition-all hover:border-slate-600 hover:bg-slate-900 panel-3d group">
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                    <div className={`p-1.5 rounded ${secret.category === 'GOV' ? 'bg-blue-900/20 text-blue-400' :
                        secret.category === 'LLM' ? 'bg-purple-900/20 text-purple-400' :
                            secret.category === 'BOT' ? 'bg-cyan-900/20 text-cyan-400' :
                                secret.category === 'CYBER' ? 'bg-red-900/20 text-red-400' :
                ...
                <div className="text-[10px] text-slate-500 font-mono flex items-center gap-2">
                    ...
                    <span className="truncate max-w-[200px] text-slate-600">vault:{secret.vaultPath}</span>
                </div>
            </div>
            ...
            <div className="flex-1 w-full md:w-auto relative group">
                {secret.requiresFile ? (
                    <div className="flex gap-2">
                        <button className="flex-1 bg-slate-950 border border-slate-700 rounded px-3 py-2 text-[10px] text-slate-300 hover:text-white hover:border-slate-500 transition-all flex items-center justify-center gap-2 btn-3d">
                            <UploadCloud size={12} /> Upload Key File (.dat/.p12)
                        </button>
                    </div>
                ) : (
                    <div className="relative">
                        <input
                            ...
                            className={`w-full bg-slate-950 border rounded px-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-primary-500 font-mono transition-all shadow-inner ${isEdited ? 'border-primary-500/50' : 'border-slate-700'}`}
                        />
                        <button
            ...
            <div className="flex items-center gap-2 w-full md:w-auto justify-end">
                <div className="flex flex-col items-end mr-2">
                    <span className={`text-[9px] font-bold uppercase ${secret.status === 'ACTIVE' ? 'text-success-500' :
                ...
                <button
                    ...
                    className="p-2 bg-slate-950 hover:bg-slate-800 text-slate-400 hover:text-white rounded border border-slate-700 transition-all btn-3d group-hover:border-slate-500"
                    title="Test Connection"
                >
                    <RefreshCw size={14} className={secret.status === 'SYNCING' ? "animate-spin" : ""} />
                </button>
            ...
            {activeSourceSubTab === 'MESSENGERS' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <TacticalCard title="Slack Integration" className="panel-3d" action={<button className="text-slate-500 hover:text-white"><Settings size={14} /></button>}>
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-4 bg-[#4A154B]/20 border border-[#4A154B]/50 rounded-lg">
                                <div className="p-3 bg-white rounded text-[#4A154B]">
        ...
        return (
            <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Vault Visualizer */}
                    <TacticalCard title="HashiCorp Vault Status" className="panel-3d" noPadding>
                        <div className="p-6 flex flex-col items-center justify-center relative overflow-hidden">
                            <div className="relative w-40 h-40">
                                {/* Rings */}
                                <div className="absolute inset-0 rounded-full border-4 border-slate-800 border-dashed animate-spin-slow"></div>
                                <div className="absolute inset-4 rounded-full border-4 border-slate-700 border-dashed animate-reverse-spin"></div>
                                <div className="absolute inset-8 rounded-full border-2 border-yellow-500/30"></div>

                                {/* Center Lock */}
                                <div className="absolute inset-0 flex items-center justify-center flex-col">
                                    <Lock size={32} className="text-yellow-500 mb-2 drop-shadow-[0_0_10px_rgba(234,179,8,0.5)]" />
                                    <span className="text-[10px] font-bold text-yellow-500 uppercase tracking-widest">UNSEALED</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 w-full space-y-2">
                                <div className="flex justify-between text-[10px] text-slate-400">
                                    ...
                                    <span className="text-white font-mono">3/5 Present</span>
                                </div>
                                <div className="flex gap-1 h-1.5">
                                    <div className="flex-1 bg-yellow-500 rounded-sm shadow-[0_0_5px_rgba(234,179,8,0.5)]"></div>
                                    <div className="flex-1 bg-yellow-500 rounded-sm shadow-[0_0_5px_rgba(234,179,8,0.5)]"></div>
                                    <div className="flex-1 bg-yellow-500 rounded-sm shadow-[0_0_5px_rgba(234,179,8,0.5)]"></div>
