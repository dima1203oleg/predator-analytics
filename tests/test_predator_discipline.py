...
from app.services.azr_engine_v32 import AZREngineV32, AZRAction
...
async def test_ledger_integrity_and_persistence(temp_storage):
    ...
    entry1 = engine1.truth_ledger.append("TEST_EVENT", {"val": 1})
    ...
    # Add second entry
    entry2 = engine2.truth_ledger.append("TEST_EVENT_2", {"val": 2})
    assert engine2.truth_ledger.merkle_root != root1
