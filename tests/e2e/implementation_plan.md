...
> [!IMPORTANT]
> - Тести відмовостійкості (Chaos Engineering) потребують прав на рестарт контейнерів або сервісів (через Docker/k3s). Чи є на NVIDIA/сервері налаштовані права для тестів керувати інфраструктурою?
