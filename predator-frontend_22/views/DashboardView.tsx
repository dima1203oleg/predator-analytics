              ...
              <TacticalCard title="Швидкі Протоколи" className={`flex-1 panel-3d ${criticalBorder}`} noPadding>
                  <div className="grid grid-cols-2 gap-2 p-3">
                      ...
                      <button 
                        ...
                        className={`flex flex-col items-center justify-center p-2 border rounded transition-all active:scale-95 group col-span-2 ${
                            isCritical ? 'bg-red-600 text-white border-red-500 animate-pulse' : 'bg-red-900/20 hover:bg-red-900/40 border-red-900/50'
                        }`}
                      >
