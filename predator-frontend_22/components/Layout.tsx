                        ...
                        <ul className="space-y-1">
                            {group.items.map((item) => (
                                <li key={item.id}>
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-3.5 md:py-2.5 text-sm font-medium rounded-md transition-all duration-200 group relative overflow-hidden btn-3d touch-manipulation ${
                                        activeTab === item.id
