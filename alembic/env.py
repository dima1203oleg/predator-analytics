"""
Alembic env.py — PREDATOR Analytics v4.2.0.

Async-supporting Alembic env for SQLAlchemy + asyncpg.
"""
import asyncio
...
# Override sqlalchemy.url from settings (async → sync for Alembic)
