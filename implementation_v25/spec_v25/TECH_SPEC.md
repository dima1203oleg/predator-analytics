...
Predator Analytics v45.0 — це AI-native аналітична платформа з мульти-агентною архітектурою, яка забезпечує:
...
- Єдиний master-документ для v45.0 з навігацією
...
- Existing v45 spec (reference): `implementation_v45/TECH_SPEC.md`
- Domain specs (reference): `docs/specs/v45_unified/*`
