...
class ComponentRegistry:
    ...
    REQUIRED_COMPONENTS: List[Dict[str, any]] = [
        ...
        },
        {
            ...
            "health_check": "check_llm_availability"
        },
        {
            "name": "ingestion",
        ...
        {
            "name": "azr",
            "module": "app.azr.engine",
            "health_check": "check_azr_constraints"
        },
        {
            "name": "security",
            "module": "app.core.security",
            "health_check": "check_auth_provider"
        },
    ]
    ...
    OPTIONAL_COMPONENTS: List[Dict[str, any]] = [
        {
            ...
            "module": "app.ai.decision_memory",
            "health_check": None
        },
        {
            "name": "simulation",
            "module": "app.analytics.simulation",
            "health_check": None
        },
    ]
