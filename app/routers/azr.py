...
from app.services.azr_engine_v32 import AZRAction, azr_engine_v32
...
async def get_azr_anomalies():
    ...
    return {
        "anomalies": orientation.get("anomalies", []),
...
async def inject_chaos(request: ChaosRequest):
    ...
    result = await azr_engine_v32.chaos._execute_scenario(request.scenario)
    return result
