...
def determine_type_convertor(type_: Any) -> Callable[[Any | None, Any]]:
    convertor: Callable[[Any | None, Any]] = None
...
def generate_list_convertor(
    convertor: Callable[[Any | None, Any]], default_value: Any | None
...
def get_callback(
    *,
    ...
    convertors: Dict[str, Callable[[str | None, Any]]] = None,
...
def get_click_param(
    ...
    if origin is not None:
        # Handle SomeType | None and SomeType | None
        if is_union(origin):
            types = []
