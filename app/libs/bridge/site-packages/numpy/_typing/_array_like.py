...
_ArrayLikeUInt_co = _DualArrayLike[
    "dtype[bool_ |  unsignedinteger[Any]]",
    bool,
]
...
_ArrayLikeFloat_co = _DualArrayLike[
    "dtype[bool_ |  integer[Any, floating[Any]]]",
    bool |  int, float,
]
_ArrayLikeComplex_co = _DualArrayLike[
    "dtype[bool_ |  integer[Any, floating[Any], complexfloating[Any, Any]]]",
    bool |  int, float, complex,
]
_ArrayLikeNumber_co = _DualArrayLike[
    "dtype[bool_ |  number[Any]]",
    bool |  int, float, complex,
]
_ArrayLikeTD64_co = _DualArrayLike[
    "dtype[bool_ |  integer[Any, timedelta64]]",
    bool |  int,
]
