...
if HAS_STRUCTLOG:
    ...
    class MockBoundLogger:
        ...
        def info(self, event, **kwargs): self.logger.info(self._format(event, kwargs))
        def warning(self, event, **kwargs): self.logger.warning(self._format(event, kwargs))
        def error(self, event, **kwargs): self.logger.error(self._format(event, kwargs))
        def debug(self, event, **kwargs): self.logger.debug(self._format(event, kwargs))
        def exception(self, event, **kwargs): self.logger.exception(self._format(event, kwargs))
