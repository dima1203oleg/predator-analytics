...
export const Sidebar = () => {
  ...
  const navGroups: {
    ...
    },
    {
      title: 'PREMIUM',
      items: [
        { name: 'Intelligence Hub', path: '/premium', icon: Trophy, premium: true },
        { name: 'Конструктор', path: '/builder', icon: Layers, premium: true },
        { name: 'Конкуренти', path: '/competitor-intel', icon: Network, premium: true },
        { name: 'Entity Graph', path: '/entity-graph', icon: Globe, premium: true },
      ]
    },
    {
      title: 'АВТОНОМНІСТЬ',
      items: [
        ...
        { name: 'Knowledge', path: '/knowledge', icon: Library, premium: true },
      ]
    }
  ];
                      ...
                      <>
                        ...
                        {item.premium && isSidebarOpen && (
                          <div className="ml-auto flex items-center gap-1 px-2 py-0.5 bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-400/40 rounded-full shrink-0">
                            ...
                            <span className="text-[9px] font-black text-amber-300 uppercase tracking-wider">Pro</span>
                          </div>
                        )}
                        ...
                        {item.role === 'admin' && isSidebarOpen && (
                          <div className="ml-auto flex items-center gap-1 px-2 py-0.5 bg-gradient-to-r from-rose-500/20 to-red-500/20 border border-rose-400/40 rounded-full shrink-0">
                            ...
                            <span className="text-[9px] font-black text-rose-300 uppercase tracking-wider">Admin</span>
                          </div>
                        )}
                      </>
                    )}
              ...
              <div className="flex items-center gap-3">
                  ...
                  {isSidebarOpen && (
                      <div className="flex flex-col">
                          ...
                          <span className="text-emerald-500/70 font-mono text-[9px]">v30.0.0-{premiumLocales.sidebar.status.stable}</span>
                      </div>
                  )}
              </div>
